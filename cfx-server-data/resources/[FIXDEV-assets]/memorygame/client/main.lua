...
RegisterNUICallback('ThermiteResult', function(data, cb)
    -- exports['FIXDEV-inventory']:ToggleHotBar(true) Toggle so that inventory doesnt work.. this was something I made on my own server.. 
...
exports('thermiteminigame', function(correctBlocks, incorrectBlocks, timetoShow, timetoLose, success, fail)
    ...
    successCb = success
    failCb = fail
    -- exports['FIXDEV-inventory']:ToggleHotBar(false) Toggle so that inventory doesnt work.. this was something I made on my own server.. 
