            ...
            switch(event.data.action) {
                ...
                case 'showMenu':
                    ...
                    $('#hud-on').on('change',function(){
                        ...
                        $.post('https://FIXDEV-hud/hud_on',JSON.stringify({
                            hud_on: hud_on
                        }));
                    });
                    ...
                    $('#compassinput').on('change',function(){
                        ...
                        $.post('https://FIXDEV-hud/compassinput',JSON.stringify({
                    ...
                    $('#compassTime').on('change',function(){
                        ...
                        $.post('https://FIXDEV-hud/compassTime',JSON.stringify({
                    ...
                    $('#compassStreet').on('change',function(){
                        ...
                        $.post('https://FIXDEV-hud/compassStreet',JSON.stringify({
                    ...
                    $('#d_minimap').on('change',function(){
                        ...
                        $.post('https://FIXDEV-hud/minimap_clip',JSON.stringify({
                            d_minimap: d_minimap
                        }));
                    });
                    ...
                    $('#speedmeter').keyup(function(){
                        ...
                        $.post('https://FIXDEV-hud/update:timer:speed',JSON.stringify({
                            fps_speed: fps_speed
                        }));
                    });
...
$('#minimap').change(function(){
    let on = this.checked
    $.post('https://FIXDEV-hud/ayar-minimap',JSON.stringify({
        minimap: on
    }));
});
...
ronin.CloseAyarMenu = function() {
    ...
    $.post('https://FIXDEV-hud/close-ayar-menu');
};
