...
function hasRadio()
    return exports["FIXDEV-inventory"]:hasEnoughOfItem("radio", 1, false) or exports["FIXDEV-inventory"]:hasEnoughOfItem("civradio", 1, false)
end
...
function handleConnectionEvent(pChannel)
    ...
    local result = exports["FIXDEV-voice"]:SetRadioFrequency(newChannel)
...
function openRadio()
    ...
    --[[ if exports["FIXDEV-base"]:getVar("call") then
...
RegisterNetEvent("FIXDEV-radio:setChannel", function(params)
...
RegisterNetEvent("FIXDEV-radio:updateRadioState", function (frequency, powered)
    SendNUIMessage({
