...
AddEventHandler('ChannelSet1', function()
  ...
  exports["FIXDEV-voice"]:setVoiceProperty("radioEnabled", true)
  exports['FIXDEV-voice']:addPlayerToRadio(1)
...
AddEventHandler('ChannelSet2', function()
  ...
  exports["FIXDEV-voice"]:setVoiceProperty("radioEnabled", true)
  exports['FIXDEV-voice']:addPlayerToRadio(2)
  PlaySound(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 0, 0, 1)
...
AddEventHandler('ChannelSet3', function()
  ...
  exports["FIXDEV-voice"]:setVoiceProperty("radioEnabled", true)
  exports['FIXDEV-voice']:addPlayerToRadio(3)
  PlaySound(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 0, 0, 1)
...
AddEventHandler('ChannelSet4', function()
  ...
  exports["FIXDEV-voice"]:setVoiceProperty("radioEnabled", true)
  exports['FIXDEV-voice']:addPlayerToRadio(4)
  PlaySound(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 0, 0, 1)
...
AddEventHandler('ChannelSet5', function()
  ...
  exports["FIXDEV-voice"]:setVoiceProperty("radioEnabled", true)
  exports['FIXDEV-voice']:addPlayerToRadio(5)
  PlaySound(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 0, 0, 1)
...
function openGui()
  ...
  elseif job == "ems" then
    Emergency = true
  elseif exports["FIXDEV-inventory"]:hasEnoughOfItem("scanner",1,false) then
    Emergency = true
  end
...
local function handleConnectionEvent(pChannel)
  ...
  if newChannel < 1.0 then
    pRadioChannel = false
    exports['FIXDEV-voice']:removePlayerFromRadio()
    exports["FIXDEV-voice"]:setVoiceProperty("radioEnabled", false)
  else
    pRadioChannel = true
    exports["FIXDEV-voice"]:setVoiceProperty("radioEnabled", true)
    exports['FIXDEV-voice']:addPlayerToRadio(newChannel)
  end
end
...
function hasRadio()
    if exports["FIXDEV-inventory"]:hasEnoughOfItem("radio", 1, false, true) or exports["FIXDEV-inventory"]:hasEnoughOfItem("civradio", 1, false, true)then
      return true
    else
      return false
    end
...
RegisterNUICallback('volumeUp', function(data, cb)
  ...
  TriggerEvent('FIXDEV-voice:SetRadioVolume', radioVolume)
...
AddEventHandler('FIXDEV-inventory:itemCheck', function (item, state, quantity)
    ...
    exports["FIXDEV-voice"]:removePlayerFromRadio(false)
