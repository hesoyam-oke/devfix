...
RegisterNetEvent("wild-clothes:notsave")
AddEventHandler("wild-clothes:notsave", function()
    TriggerEvent("FIXDEV-spawn:finishedClothing","Old")
    LoadPed(oldPed)
end)

RegisterNetEvent("wild-clothes:save")
AddEventHandler("wild-clothes:save", function()
