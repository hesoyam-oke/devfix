...
RegisterUICallback("FIXDEV-ui:raid_clothes:addOutfitPrompt", function(data, cb)
...
RegisterUICallback("FIXDEV-ui:raid_clothes:addOutfit", function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
...
RegisterUICallback("FIXDEV-ui:raid_clothes:changeOutfit", function(data, cb)
    cb({ data = {}, meta = { ok = true, message = 'done' } })
    TriggerEvent('hotel:outfit', { true, data.key }, 3)
    exports["FIXDEV-interface"]:hideContextMenu()
end)

RegisterUICallback("FIXDEV-ui:raid_clothes:deleteOutfit", function(data, cb)
    cb({ data = {}, meta = { ok = true, message = 'done' } })
...
RegisterUICallback("FIXDEV-ui:raid_clothes:CustomaddOutfitPrompt", function(data, cb)
    cb({ data = {}, meta = { ok = true, message = 'done' } })
    Wait(1) --wait to fix ui bug?
    exports['FIXDEV-interface']:openApplication('textbox', {
...
RegisterUICallback("FIXDEV-ui:raid_clothes:addCustomOutfit", function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
