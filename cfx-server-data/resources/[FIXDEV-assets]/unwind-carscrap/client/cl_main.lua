...
AddEventHandler("unwind-carscrap:ScrapVehicle", function()
    if exports["FIXDEV-inventory"]:hasEnoughOfItem("scraptoolset",1,false) then
...
AddEventHandler("unwind-carscrap:StartScrappingVin", function()
    ...
    local finished = exports["FIXDEV-taskbar"]:taskBar(20000,"Scrapping Car")
...
AddEventHandler("unwind-carscrap:StartCarScrappingProcess", function()
    local vehicle = exports['FIXDEV-target']:GetCurrentEntity()
...
function ChopVehicleTyre(vehicle, boneID, tyreIndex)
    ...
    local finished = exports["FIXDEV-taskbar"]:taskBar(10000,"Scrapping Car")
...
function ChopVehicleDoor(vehicle, boneID, doorIndex)
    ...
    local finished = exports["FIXDEV-taskbar"]:taskBar(14000,"Scrapping Car")
...
function ChopVehicleRemains(vehicle, boneID)
    ...
    local finished = exports["FIXDEV-taskbar"]:taskBar(25000,"Scrapping Car")
