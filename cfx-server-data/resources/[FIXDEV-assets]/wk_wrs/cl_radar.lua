...
AddEventHandler("platecheck:frontradar", function()
    TriggerServerEvent('FIXDEV:vehicles:plateCheck',radarInfo.frontPlate)
end)

RegisterNetEvent("platecheck:rearradar")
AddEventHandler("platecheck:rearradar", function()
    TriggerServerEvent('FIXDEV:vehicles:plateCheck',radarInfo.rearPlate)
end)
...
function isVehicleFlagged(veh, plate)
    return exports["FIXDEV-vehicles"]:GetVehicleMetadata(veh, "isFlagged") or
    RPC.execute('FIXDEV:vehicles:isFlagged', plate)
end
