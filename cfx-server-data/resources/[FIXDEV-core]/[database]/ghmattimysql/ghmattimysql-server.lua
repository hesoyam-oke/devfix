...
exports('executeSync', function (query, parameters)
  ...
  exports.oxmysql:execute(query, safeParameters(parameters), function (result)
    res = result
    finishedQuery = true
...
exports('scalarSync', function (query, parameters)
  local res = {}
  local finishedQuery = false
  exports.oxmysql:scalar(query, safeParameters(parameters), function (result)
    res = result
    finishedQuery = true
  end, GetInvokingResource())
  repeat Citizen.Wait(0) until finishedQuery == true
...
exports('transactionSync', function (query, parameters)
  ...
  exports.oxmysql:transaction(query, safeParameters(parameters), function (result)
    res = result
...
exports('storeSync', function (query)
  ...
  exports.oxmysql:store(query, function (result)
    res = result
    finishedStore = true
  end, GetInvokingResource())
