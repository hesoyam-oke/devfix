...
RegisterNetEvent('FIXDEV:admin/client/fling-player', function()
...
RegisterNetEvent("FIXDEV:admin/client/select-spawn", function()
...
RegisterNetEvent("FIXDEV:admin:ReviveInDistance")
AddEventHandler("FIXDEV:admin:ReviveInDistance", function()
    local playerList = {}
    ...
    for index,value in ipairs(players) do
        ...
        if(distance < 50) then
            TriggerServerEvent('FIXDEV:admin:revive_in_distance')
    ...
    if playerList ~= {} and playerList ~= nil then
        ...
        for k,v in pairs(playerList) do
            TriggerServerEvent("ragdoll:reviveSV", v)
...
AddEventHandler("FIXDEV:admin:noClipToggle", function(pIsEnabled)
...
Citizen.CreateThread( function()
  ...
  function getVehiclesCombined() 
    ...
    local vehicleTable = exports['FIXDEV-admin']:getVehicles()
    local addonVehicleTable = exports['FIXDEV-admin']:getAddonVehicles()
  ...
  RegisterNetEvent('FIXDEV-admin:InsertPrioCL')
  AddEventHandler('FIXDEV-admin:InsertPrioCL', function()
    TriggerServerEvent('FIXDEV-admin:insertPrio')
  end)