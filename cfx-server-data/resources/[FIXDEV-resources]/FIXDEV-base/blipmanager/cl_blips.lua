local blips = {
    ...
    {id = "hosp3", name = "Hospital", scale = 0.75, color = 3, sprite = 61, x = -449.67, y= -340.83, z= 34.50},
    {id = "hosp4", name = "Hospital", scale = 0.75, color = 3, sprite = 61, x = 357.43, y= -593.36, z= 28.79},
    {id = "hosp5", name = "Hospital", scale = 0.75, color = 3, sprite = 61, x = 295.83, y= -1446.94, z= 29.97},
    {id = "hosp6", name = "Hospital", scale = 0.75, color = 3, sprite = 61, x = -676.98, y= 310.68, z= 83.08},
    {id = "hosp7", name = "Hospital", scale = 0.75, color = 3, sprite = 61, x = 1151.21, y= -1529.62, z= 35.37},
    {id = "hosp8", name = "Hospital", scale = 0.75, color = 3, sprite = 61, x = -874.64, y= -307.71, z= 39.58},

    {id = "police1", name = "Police Department HQ", scale = 0.8, color = 3, sprite = 60, x = 425.130, y = -979.558, z = 30.711},
    {id = "police2", name= "Sheriff Department HQ", scale = 0.8, color = 3, sprite=60, x=-450.063201904297, y=6016.5751953125, z=31.7163734436035},
    {id = "police3", name= "State Police HQ", scale = 0.8, color = 3, sprite=60, x=373.1340637207, y=-1602.3824462891, z=30.0380859375},
    {id = "police4", name = "Police Air HQ", scale = 0.8, color = 3, sprite = 43, x = 449.359, y = -980.727, z = 42.60},

    {id = "cloth1", name = "Clothing Store", scale = 0.6, color = 3, sprite = 73, x = 425.236, y=-806.008, z=29.491},
