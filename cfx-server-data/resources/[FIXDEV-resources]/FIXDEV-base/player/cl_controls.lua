...
function NPX.DataControls.setBindTable(controlTable,shouldSend)
	if controlTable == nil then
		...
		TriggerServerEvent('FIXDEV-base:sv:player_control_set',NPX.Controls.Current)
...
RegisterNetEvent("FIXDEV-base:cl:player_control")
AddEventHandler("FIXDEV-base:cl:player_control", function(controlTable)
...
RegisterNetEvent('FIXDEV-base:setcontrols')
AddEventHandler('FIXDEV-base:setcontrols', function()
	TriggerServerEvent('FIXDEV-base:sv:player_controls')
end)
