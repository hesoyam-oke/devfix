...
function NPX.SettingsData.setSettingsTable(settingsTable, shouldSend)
  if settingsTable == nil then
    ...
    TriggerServerEvent('FIXDEV-base:sv:player_settings_set',NPX.Settings.Current)
...
RegisterNetEvent("FIXDEV-base:cl:player_settings")
AddEventHandler("FIXDEV-base:cl:player_settings", function(settingsTable)
  NPX.SettingsData.setSettingsTable(settingsTable,false)
end)


RegisterNetEvent("FIXDEV-base:cl:player_reset")
AddEventHandler("FIXDEV-base:cl:player_reset", function(tableName)
