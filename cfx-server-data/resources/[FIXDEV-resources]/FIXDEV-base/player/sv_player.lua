...
local function AddMethod(player)
    ...
    function player.networkVar(self, var, data)
        ...
        TriggerClientEvent("FIXDEV-base:networkVar", GetUser(self):getVar("source"), var, data)
    end
...
local pos = {}
RegisterServerEvent('FIXDEV-base:updatecoords')
AddEventHandler('FIXDEV-base:updateCoords', function(x,y,z)
    local src = source
    pos[src] = {x,y,z}
end)
...
AddEventHandler("playerDropped", function(reason)
    ...
    TriggerEvent('FIXDEV-base:playerDropped', src, user)
end)
