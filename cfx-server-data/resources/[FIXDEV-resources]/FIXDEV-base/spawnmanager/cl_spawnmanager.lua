...
function NPX.SpawnManager.Initialize(self)
    Citizen.CreateThread(function()
        ...
        TriggerEvent("FIXDEV-base:spawnInitialized")
        TriggerServerEvent("FIXDEV-base:spawnInitialized")
...
function NPX.SpawnManager.InitialSpawn(self)
    Citizen.CreateThread(function()
        ...
        TriggerEvent("FIXDEV-clothing:applyCurrentClothing")
...
AddEventHandler("FIXDEV-base:firstSpawn", function()
...
RegisterNetEvent('FIXDEV-base:clearStates')
AddEventHandler('FIXDEV-base:clearStates', function()
