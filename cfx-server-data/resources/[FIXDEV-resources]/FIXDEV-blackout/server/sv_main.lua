function BlackoutTimer()
    ...
    TriggerClientEvent("FIXDEV:client:blackout", -1, CONFIG.BlackoutStatus)
end
...
RegisterServerEvent("FIXDEV:server:blackout")
AddEventHandler("FIXDEV:server:blackout",function()
    local src = source 
    TriggerClientEvent("FIXDEV:client:blackout", -1, CONFIG.BlackoutStatus)
end)