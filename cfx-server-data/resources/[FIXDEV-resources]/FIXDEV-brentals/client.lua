RegisterNetEvent('FIXDEV-bikerent:menu')
AddEventHandler('FIXDEV-bikerent:menu', function()                           
  TriggerEvent('FIXDEV-context:sendMenu', {
        ...
        },
        {
			...
			params = {
                event = "FIXDEV-bikerent:checkmoney",
                args = {
                    car = Config.bike1,
...
RegisterNetEvent('FIXDEV-bikerent:checkmoney')
AddEventHandler('FIXDEV-bikerent:checkmoney', function(data)                            
        local vehicle = data.car
        local price = data.price
        TriggerServerEvent("FIXDEV-bikerent:hasmoney", price, vehicle)

end)

RegisterNetEvent('FIXDEV-bikerent:spawnbike')
AddEventHandler('FIXDEV-bikerent:spawnbike', function(vehicleName)                            
