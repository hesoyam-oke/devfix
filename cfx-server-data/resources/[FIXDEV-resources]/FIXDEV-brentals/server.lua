RegisterServerEvent('FIXDEV-bikerent:hasmoney')
AddEventHandler('FIXDEV-bikerent:hasmoney', function(price, vehicle)
    ...
    if money >= price then
            ...
            TriggerClientEvent("FIXDEV-bikerent:spawnbike", user.source, vehicleName)
    else
