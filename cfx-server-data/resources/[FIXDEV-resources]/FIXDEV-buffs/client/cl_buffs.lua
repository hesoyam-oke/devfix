...
AddEventHandler("FIXDEV-buffs:stamina", function(pEnabled, pPercent)
...
AddEventHandler("FIXDEV-buffs:setJobLuckMultiplier", function(pJobLuckMultiplier)
  jobLuckMultiplier = 1 + pJobLuckMultiplier + 0.0
  TriggerServerEvent("FIXDEV-buffs:setBuffValue", "jobluck", jobLuckMultiplier)
end)
...
AddEventHandler("FIXDEV-buffs:setAlertLevelMultiplier", function(pAlertLevelMultiplier)
...
AddEventHandler("FIXDEV-buffs:inDoubleBuffZone", function(pBool)
  ...
  Citizen.CreateThread(function()
    ...
    while isSitting and inRestaurantBuffZone do
      if minuteCount >= 5 then
        ...
        TriggerEvent("FIXDEV-buffs:applyBuff", "restaurant_double", {{ buff = "double", percent = percent }})
      end
      Citizen.Wait(60000)
