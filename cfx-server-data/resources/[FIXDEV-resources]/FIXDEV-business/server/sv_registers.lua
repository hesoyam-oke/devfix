...
RPC.register("FIXDEV-business:startPurchase", function(pSource, pData)
    ...
    TriggerClientEvent("FIXDEV-business:activePurchase", -1, insert)
end)
...
RPC.register("FIXDEV-business:completePurchase", function(pSource, pData)
    ...
    local owner = exports["FIXDEV-base"]:getModule("Player"):GetUser(data.charger)
    ...
    TriggerClientEvent("FIXDEV-business:closePurchase", -1, insert)

    TriggerClientEvent('FIXDEV-phone:businessRegisterNoti', pSource, "SERVICE CHARGE", message)
