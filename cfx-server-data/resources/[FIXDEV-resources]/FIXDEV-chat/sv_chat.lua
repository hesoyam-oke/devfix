...
RegisterServerEvent('FIXDEV-chat:me:Log')
AddEventHandler('FIXDEV-chat:me:Log', function(text)
    local src = source
    local user = exports["FIXDEV-base"]:getModule("Player"):GetUser(src)
