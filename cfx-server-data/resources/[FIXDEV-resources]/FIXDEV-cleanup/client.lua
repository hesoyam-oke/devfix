...
AddEventHandler("FIXDEV-cleanup:enableCleanup", function(pEnabled)
  skipCleanupChecks = not pEnabled
end)

AddEventHandler("FIXDEV-cleanup:addBlacklistedProp", function(pProp)
...
local bypassObjects = {}
AddEventHandler('FIXDEV-objects:objectCreated', function(pObject, pHandle)
...
AddEventHandler('FIXDEV-objects:objectRecreating', function(pObject, pHandle)
    bypassObjects[pHandle] = nil
end)

AddEventHandler('FIXDEV-objects:objectRecreated', function(pObject, pHandle)
    bypassObjects[pHandle] = true
end)
...
RegisterNetEvent('FIXDEV-cleanup:clearAreaOfEverything')
AddEventHandler('FIXDEV-cleanup:clearAreaOfEverything', function (vectors, radius)
    ClearAreaOfEverything(vectors.x, vectors.y, vectors.z, radius, false, false, false, false)
end)

RegisterNetEvent('FIXDEV-cleanup:clearAreaOfObjects')
AddEventHandler('FIXDEV-cleanup:clearAreaOfObjects', function (vectors, radius)
    ClearAreaOfObjects(vectors.x, vectors.y, vectors.z, radius)
end)

RegisterNetEvent('FIXDEV-cleanup:clearAreaOfPeds')
AddEventHandler('FIXDEV-cleanup:clearAreaOfPeds', function (vectors, radius)
    ClearAreaOfPeds(vectors.x, vectors.y, vectors.z, radius)
end)

RegisterNetEvent('FIXDEV-cleanup:clearAreaOfVehicles')
AddEventHandler('FIXDEV-cleanup:clearAreaOfVehicles', function (vectors, radius)
