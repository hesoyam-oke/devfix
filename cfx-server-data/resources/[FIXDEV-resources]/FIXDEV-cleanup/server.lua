...
RegisterCommand('clearAreaOf', function(src, args)
    ...
    if clearType == nil or clearType == 'everything' then
        TriggerClientEvent('FIXDEV-cleanup:clearAreaOfEverything', -1, vectors, radius + 0.0)
    elseif clearType == 'objects' then
        TriggerClientEvent('FIXDEV-cleanup:clearAreaOfObjects', -1, vectors, radius + 0.0)
    elseif clearType == 'vehicles' then
        TriggerClientEvent('FIXDEV-cleanup:clearAreaOfVehicles', -1, vectors, radius + 0.0)
    elseif clearType == 'peds' then
        TriggerClientEvent('FIXDEV-cleanup:clearAreaOfPeds', -1, vectors, radius + 0.0)
    end
end)