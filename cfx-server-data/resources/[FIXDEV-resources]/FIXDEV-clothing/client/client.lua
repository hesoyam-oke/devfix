...
CreateThread(function()
    local TextureNames = RPC.execute("FIXDEV-clothing:getTextureNames")
    Config.SetShops()
    Citizen.Wait(500)
    return TextureNames
end)
...
RegisterNUICallback("closeNui", function(buy)
    ...
    exports["FIXDEV-clothing"]:closeCamera()
    ...
    TriggerEvent("FIXDEV-clothing:save")
    if firstspawn then
        firstspawn = false
...
function OpenShops(type, bool)
    ...
    exports["FIXDEV-clothing"]:setCamera(3)
...
RegisterNetEvent("FIXDEV-clothing:opeFIXDEV-clothing", OpenShops)
