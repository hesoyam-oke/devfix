...
function InitMenu()
    TriggerServerEvent("FIXDEV-clothes/loadPlayerSkin")
    CreateBlips()
    LoadAnims()
...
RegisterCommand('testy', function(source, args, RawCommand)
    print("succes")
    TriggerEvent("FIXDEV-clothing:client:openMenu")
...
RegisterNetEvent('FIXDEV-clothing:client:openMenu', function()
    openMenu({
...
RegisterNetEvent('FIXDEV-clothing/client/getOutfits', function(Job, Grade)
...
RegisterNetEvent('FIXDEV-clothes:client:CreateFirstCharacter', function()
    local LocalPlayer = exports["FIXDEV-base"]:getModule("LocalPlayer")
...
RegisterNetEvent("FIXDEV-clothes:loadSkin", function(new, model, data)
    ...
    Citizen.CreateThread(function()
        ...
        TriggerEvent('FIXDEV-clothing:client:loadPlayerClothing', data, PlayerPedId())
    end)
end)

RegisterNetEvent('FIXDEV-clothing:client:loadPlayerClothing', function(data, ped)
...
RegisterNetEvent('FIXDEV-clothing/client/loadOutfit', function(oData)
...
RegisterNetEvent("FIXDEV-clothes/client/loadPlayerSkin", function()
    TriggerServerEvent('FIXDEV-clothes/loadPlayerSkin')
end)
...
RegisterNUICallback('selectOutfit', function(data, cb)
    TriggerEvent('FIXDEV-clothing/client/loadOutfit', data)
    cb('ok')
end)
...
RegisterNUICallback('saveOutfit', function(data, cb)
    ...
    TriggerServerEvent('FIXDEV-clothes/saveOutfit', data.outfitName, model, Config.SkinData)
    cb('ok')
end)
...
RegisterNUICallback('removeOutfit', function(data, cb)
    TriggerServerEvent('FIXDEV-clothing/server/removeOutfit', data.outfitName, data.outfitId)
...
RegisterNUICallback('toggleVariation', function(data, cb)
    ...
    TriggerEvent('FIXDEV-clothing/client/loadOutfit', ClothingData)
    cb('ok')
end)
...
RegisterNUICallback('saveClothing', function(Data, cb)
    ...
    --local purchaseSuccess = RPC.execute("wild-clothing:purchase", currentPrice)
    --if not purchaseSuccess then
    SaveSkin(Data.IsAdmin)
    TriggerEvent("FIXDEV-spawn:finishedClothing","Finished")
    TriggerEvent("wild-clothes:save")
    cb('ok')
    --else
        --TriggerServerEvent("raid_clothes:get_character_current")
    --end
