...
Config.Debug = true
Config.UseTarget = false -- true = Target Eye (Requires: FIXDEV-target), false = Polyzones (Requires: PolyZone)
Config.ContextMenu = 'FIXDEV-context' -- Script name for the context menu
