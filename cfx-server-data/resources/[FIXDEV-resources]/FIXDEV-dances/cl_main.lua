...
RegisterNetEvent('FIXDEV:dances:dance')
AddEventHandler('FIXDEV:dances:dance', function(pDance)
...
RegisterCommand('dance', function(source, args)
    ...
    if not sex or sex == nil or sex == "" then
     TriggerEvent('FIXDEV:dances:dance', -1)
    else
        TriggerEvent('FIXDEV:dances:dance', tonumber(args[1]))
    end
end)