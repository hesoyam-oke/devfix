...
RegisterNetEvent("FIXDEV-dirtymoney:allowDirtyMoneyDrops")
AddEventHandler("FIXDEV-dirtymoney:allowDirtyMoneyDrops", function()
...
RegisterNetEvent("FIXDEV-dirtymoney:attemptDirtyMoneyDrops")
AddEventHandler("FIXDEV-dirtymoney:attemptDirtyMoneyDrops", function()
	if DropOffTime == 0 then
		TriggerEvent('FIXDEV-dirtymoney:allowDirtyMoneyDrops')
		--TriggerServerEvent('mobdelivery:checkjob')
		--TriggerServerEvent("FIXDEV-dirtymoney:alterDirtyMoney", "TurnToCash", 0)
	else
...
if DirtyMoney >= amount then
	local pos = GetEntityCoords(PlayerPedId())
		...
		TriggerServerEvent("FIXDEV-dirtymoney:alterDirtyMoney","ItemDrop",amount)
