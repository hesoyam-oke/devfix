...
RegisterNetEvent("FIXDEV-editor:buildName")
AddEventHandler("FIXDEV-editor:buildName", function(name,objects, offsets)
    if objects then
...
RegisterNetEvent("FIXDEV-editor:destroyName")
AddEventHandler("FIXDEV-editor:destroyName", function(name)
    cleanUpArea(name)
