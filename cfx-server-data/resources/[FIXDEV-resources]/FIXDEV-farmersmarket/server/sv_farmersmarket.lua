...
RPC.register("FIXDEV-farmersmarket:claimBooth", function(pSource, pBoothId, pCharacterId, pPassword)
    ...
    TriggerClientEvent("FIXDEV-farmersmarket:updateBoothSettings", pSource, boothSettings)
end)

RPC.register("FIXDEV-farmersmarket:leaveBooth", function(pSource, pBoothId, pCharacterId)
...
RPC.register("FIXDEV-farmersmarket:joinBooth", function(pSource, pBoothId, pCharacterId, pPassword)
    if not boothSettings[pBoothId] then
        TriggerClientEvent("DoLongHudText", pSource, "Booth not claimed", 2)
        return
    end
...
RPC.register("FIXDEV-farmersmarket:isAtBooth", function(pSource, pBoothId, pCharacterId)
    if not boothSettings[pBoothId] then
        TriggerClientEvent("DoLongHudText", pSource, "Booth not claimed", 2)
        return
    end
...
RPC.register("FIXDEV-farmersmarket:getBoothCids", function(pSource, pBoothId)
    print("getBoothCids", pBoothId)
end)

RPC.register("FIXDEV-farmersmarket:getBoothSettings", function(pSource, pArea)
    local boothQ = {}
...
RPC.register("FIXDEV-farmersmarket:changeBoothImage", function(pSource, pBoothId, pCharacterId, pBanner)
...
RPC.register("FIXDEV-farmersmarket:getCraftItem", function(pSource, pId)
    print("getCraftItem", pId)
end)

RPC.register("FIXDEV-farmersmarket:registerItem", function(pSource, pData, pCid)
    print("registerItem", pData, pCid)
end)

RPC.register("FIXDEV-farmersmarket:registerBanner", function(pSource, pData, pCid)
    local src = source
...
RPC.register("FIXDEV-farmersmarket:getFarmersItems", function(pSource, pSearch)
    print("getFarmersItems", pSearch)
end)

RPC.register("FIXDEV-farmersmarket:farmersItemAction", function(pSource, pData)
