RegisterNetEvent("FIXDEV:flags:get")
AddEventHandler("FIXDEV:flags:get", function(callID, netID, entityType, flagType)
    ...
    TriggerServerEvent("FIXDEV:flags:set", callID, netID, flagType, flags)
end)

RegisterNetEvent("FIXDEV:flags:set")
AddEventHandler("FIXDEV:flags:set", function(netID, entityType, flagType, flags)
    local entity = nil
...
function NotifyChange(pType, pEntity, pFlag, pState)
    local event = ('FIXDEV:flags:%s:stateChanged'):format(pType)
