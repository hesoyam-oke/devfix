...
RegisterNetEvent('FIXDEV-robbery:smallBankAttempt')
AddEventHandler('FIXDEV-robbery:smallBankAttempt', function(bId)
    ...
    TriggerClientEvent('FIXDEV-robbery:updateBankData', -1, banks)
end)

RegisterNetEvent('FIXDEV-robbery:sBankBox')
AddEventHandler('FIXDEV-robbery:sBankBox', function(bId, iType)

    banks[bId]['rob'][iType] = true
    TriggerClientEvent('FIXDEV-robbery:updateBankData', -1, banks)
    TriggerClientEvent('FIXDEV-robbery:sBankLoot', source)
end)

RegisterNetEvent('FIXDEV-robbery:PoliceNotifyFleeeee')
AddEventHandler('FIXDEV-robbery:PoliceNotifyFleeeee', function()

    TriggerClientEvent("FIXDEV-fleeca:policenotify", -1, bank)
