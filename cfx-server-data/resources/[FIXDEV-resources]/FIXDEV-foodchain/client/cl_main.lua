...
Citizen.CreateThread(function()
    serverCode = "wl"
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_signon', {{
        event = "FIXDEV-foodchain:signOnPrompt",
    ...
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_signon', {{
        event = "FIXDEV-foodchain:getActiveEmployees",
    ...
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_signon_pier', {{
        event = "FIXDEV-foodchain:signOnPrompt",
    ...
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_signon', {{
        event = "FIXDEV-foodchain:signOffPrompt",
    ...
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_shelfstorage', {{
        event = "FIXDEV-foodchain:shelfPrompt",
        id = "food_chain_shelf_storage",
        icon = "box-open",
        label = _L("foodchain-open", "Open")
    }}, { distance = { radius = 3.5 }  })

    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_shelfstorage2', {{
        event = "FIXDEV-foodchain:shelfPrompt2",
        id = "food_chain_shelf_storage_pier",
        icon = "box-open",
        label = _L("foodchain-open", "Open")
    }}, { distance = { radius = 3.5 }  })

    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_fridge', {{
        event = "FIXDEV-foodchain:fridgePrompt",
        id = "food_chain_fridge",
        icon = "box-open",
        label = _L("foodchain-open", "Open")
    }}, { distance = { radius = 3.5 }  })

    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_fridge2', {{
        event = "FIXDEV-foodchain:fridgePrompt2",
        id = "food_chain_fridge_pier",
        icon = "box-open",
        label = _L("foodchain-open", "Open")
    }}, { distance = { radius = 3.5 }  })

    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_drivethruwindow', {{
        event = "FIXDEV-foodchain:pickupPromptWindow",
        id = "food_chain_order_pickup_tray3",
        icon = "hand-holding",
        label = _L("foodchain-open", "Open")
    }}, { distance = { radius = 7.0 }  })

    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_bagging', {{
        event = "FIXDEV-foodchain:getBag",
    ...
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_bagging', {{
        event = "FIXDEV-foodchain:getMeal",
    ...
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_bagging', {{
        event = "FIXDEV-foodchain:getToysPrompt",
    ...
    --Stations
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_station0', {{
        event = "FIXDEV-foodchain:stationPrompt",
    ...
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_station1', {{
        event = "FIXDEV-foodchain:stationPrompt",
    ...
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_station2', {{
        event = "FIXDEV-foodchain:stationPrompt",
    ...
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_station3', {{
        event = "FIXDEV-foodchain:stationPrompt",
    ...
    exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("FIXDEV-foodchain:burgerjob_shelfstorage", {{
        event = "FIXDEV-foodchain:silentAlarm",
    ...
    local purchasePeekData = {{
        event = "FIXDEV-foodchain:registerPurchasePrompt",
        icon = "cash-register",
    ...
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_register1', purchasePeekData, purchasePeekOptions)

    purchasePeekData[1].id = 'food_chain_register_customer_2'
    purchasePeekData[1].parameters = {registerId = 2}
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_register2', purchasePeekData, purchasePeekOptions)

    purchasePeekData[1].id = 'food_chain_register_customer_3'
    purchasePeekData[1].parameters = {registerId = 3}
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_register3', purchasePeekData, purchasePeekOptions)

    purchasePeekData[1].id = 'food_chain_register_customer_4'
    purchasePeekData[1].parameters = {registerId = 4}
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_drivethruwindow', purchasePeekData, { distance = { radius = 7.0 } })

    purchasePeekData[1].id = 'food_chain_register_customer_5'
    purchasePeekData[1].parameters = {registerId = 5}
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_register_pier', purchasePeekData, { distance = { radius = 4.0 } })
    


    local registerPeekData = {{
        event = "FIXDEV-foodchain:registerChargePrompt",
        icon = "credit-card",
    ...
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_register1', registerPeekData, registerPeekOptions)
    
    registerPeekData[1].id = 'food_chain_register_worker_2'
    registerPeekData[1].parameters = { registerId = 2 }
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_register2', registerPeekData, registerPeekOptions)

    registerPeekData[1].id = 'food_chain_register_worker_3'
    registerPeekData[1].parameters = { registerId = 3 }
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_register3', registerPeekData, registerPeekOptions)

    registerPeekData[1].id = 'food_chain_register_worker_4'
    registerPeekData[1].parameters = { registerId = 4 }
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_register4', registerPeekData, registerPeekOptions)

    registerPeekData[1].id = 'food_chain_register_worker_5'
    registerPeekData[1].parameters = { registerId = 5 }
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('FIXDEV-foodchain:burgerjob_register_pier', registerPeekData, registerPeekOptions)
end)
...
RegisterUICallback('FIXDEV-foodchain:orderFood', function (data, cb)
...
AddEventHandler('FIXDEV-foodchain:signOnPrompt', function(pParameters, pEntity, pContext)
    isSignedOn, langString, message = RPC.execute("FIXDEV-foodchain:tryJoinJob", pParameters.location)
    if isSignedOn then
        --Build Context Menus
            ...
            for k, item in pairs(data) do
                if not item.cid or item.cid == cid then
                  temp[#temp+1] = {
                      ...
                      action = "FIXDEV-foodchain:orderFood",
...
AddEventHandler('FIXDEV-foodchain:signOffPrompt', function(pParameters, pEntity, pContext)
    TriggerEvent("DoLongHudText", _L("foodchain-clocked-out", "Clocked out."))
    RPC.execute("FIXDEV-foodchain:leaveJob")
    isSignedOn = false
end)

AddEventHandler('FIXDEV-foodchain:pickupPromptWindow', function(pParameters, pEntity, pContext)
    TriggerEvent("server-inventory-open", "1", "burgerjob_window-" .. serverCode)
end)

AddEventHandler('FIXDEV-foodchain:shelfPrompt', function(pParameters, pEntity, pContext)
    TriggerEvent("server-inventory-open", "1", "burgerjob_shelf-" .. serverCode)
end)

AddEventHandler('FIXDEV-foodchain:shelfPrompt2', function(pParameters, pEntity, pContext)
    TriggerEvent("server-inventory-open", "1", "burgerjob_shelf2-" .. serverCode)
end)

AddEventHandler('FIXDEV-foodchain:fridgePrompt', function(pParameters, pEntity, pContext)
    TriggerEvent("server-inventory-open", "1", "burgerjob_fridge-" .. serverCode)
end)

AddEventHandler('FIXDEV-foodchain:fridgePrompt2', function(pParameters, pEntity, pContext)
    TriggerEvent("server-inventory-open", "1", "burgerjob_fridge2-" .. serverCode)
end)

AddEventHandler('FIXDEV-foodchain:getBag', function(pParameters, pEntity, pContext)
...
AddEventHandler('FIXDEV-foodchain:getMeal', function(pParameters, pEntity, pContext)
    RPC.execute("FIXDEV-foodchain:getMurderMeal")
end)

AddEventHandler('FIXDEV-foodchain:getToysPrompt', function()
  exports["FIXDEV-ui"]:openApplication("textbox", {
    callbackUrl = "FIXDEV-foodchain:ui:getToysPrompt",
    key = "FIXDEV-foodchain:ui:getToysPrompt",
    items = {
      {
        icon = "meh-rolling-eyes",
...
RegisterUICallback("FIXDEV-foodchain:ui:getToysPrompt", function(data, cb)
  cb({ data = {}, meta = { ok = true, message = "" } })
...
AddEventHandler('FIXDEV-foodchain:stationPrompt', function(pParameters, pEntity, pContext)
    ...
    local isActive = RPC.execute("FIXDEV-foodchain:isStationActive", pParameters.stationId)
    ...
    if not isActive then
        ...
        local failedContext = {{
            ...
            action = "FIXDEV-foodchain:cleanStation",
...
AddEventHandler('FIXDEV-foodchain:registerPurchasePrompt', function(pParameters, pEntity, pContext)
    ...
    local acceptContext = {{
        ...
        action = "FIXDEV-foodchain:finishPurchasePrompt",
...
AddEventHandler('FIXDEV-foodchain:registerChargePrompt', function(pParameters, pEntity, pContext)
    exports['FIXDEV-ui']:openApplication('textbox', {
        callbackUrl = 'FIXDEV-ui:foodchain:charge',
...
RegisterUICallback('FIXDEV-foodchain:cleanStation', function(data, cb)
    ...
    if not failed then
        RPC.execute("FIXDEV-foodchain:setStationActive", data.key.stationId)
        TriggerEvent("DoLongHudText", _L("foodchain-station-cleaned", "Station cleaned."))
    end
end)

RegisterUICallback('FIXDEV-foodchain:finishPurchasePrompt', function (data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    local success = RPC.execute("FIXDEV-foodchain:completePurchase", data.key)
    if not success then
        TriggerEvent("DoLongHudText", _L("foodchain-could-not-complete-purchase", "The purchase could not be completed."))
    end
end)

RegisterUICallback("FIXDEV-ui:foodchain:charge", function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    exports['FIXDEV-ui']:closeApplication('textbox')
    ...
    RPC.execute("FIXDEV-foodchain:startPurchase", {cost = cost, comment = comment, registerId = data[3].value})
end)

--Add to purchases at registerId pos
RegisterNetEvent('FIXDEV-foodchain:activePurchase')
AddEventHandler("FIXDEV-foodchain:activePurchase", function(data)
    activePurchases[data.registerId] = data
end)

--Remove at registerId pos
RegisterNetEvent('FIXDEV-foodchain:closePurchase')
AddEventHandler("FIXDEV-foodchain:closePurchase", function(data)
    activePurchases[data.registerId] = nil
end)

--Getting fired
RegisterNetEvent('FIXDEV-foodchain:firedEmployee')
AddEventHandler("FIXDEV-foodchain:firedEmployee", function(langString, defaultString)
    isSignedOn = false
    TriggerEvent("DoLongHudText", _L(langString, defaultString), 2)
end)

--Firing someone
RegisterNetEvent('FIXDEV-foodchain:burgerjob_fire')
AddEventHandler("FIXDEV-foodchain:burgerjob_fire", function(employee)
    if employee == nil then return end
    local success = RPC.execute("FIXDEV-foodchain:fireEmployee", employee)
    if success then 
...
AddEventHandler("FIXDEV-inventory:itemUsed", function(item, info)
    ...
    if item == "randomtoy" or item == "randomtoy2" or item == "randomtoy3" then
        local finished = exports["FIXDEV-taskbar"]:taskBar(1000, _L("foodchain-opening", "Opening"))
        if finished == 100 then
...
AddEventHandler('FIXDEV-foodchain:getActiveEmployees', function ()
    local employees = RPC.execute('FIXDEV-foodchain:server:getActiveEmployees')
...
AddEventHandler("FIXDEV-polyzone:enter", function(zone, data)
    if zone == "FIXDEV-foodchain:burgerjob_outsidenear" then
        TriggerEvent('FIXDEV-voice:setQuietMode', 'burgershot', true, 2)
    end

    if zone == "FIXDEV-foodchain:burgerjob_interior" then
        --TriggerEvent('FIXDEV-voice:setVoiceProximity', 1)
    end

    if zone == "FIXDEV-foodchain:burgerjob_intercom_outside" then
        TriggerEvent('FIXDEV:fiber:voice-event', 'intercom', 85, 2, true)
        exports["FIXDEV-ui"]:sendAppEvent("hud", { burgerShotIntercom = true })
    end

    if zone == "FIXDEV-foodchain:burgerjob_line" then
        local canUse = RPC.execute("FIXDEV-foodchain:canUseStore")
        if canUse then
            inLine = true
            Citizen.CreateThread(function()
                ...
                while inLine do
                    if not promptShowing then
                        exports["FIXDEV-ui"]:showInteraction(_L("foodchain-wait-in-line", "[E] Wait in Line"))
                        promptShowing = true
                    end
                    if IsControlJustPressed(1, 38) then
                        exports["FIXDEV-ui"]:hideInteraction()
                        local finished = exports["FIXDEV-taskbar"]:taskBar(10000, _L("foodchain-ordering", "Ordering Food"), false, true, false, false, nil, 5.0, PlayerPedId())
                        if finished == 100 then
...
AddEventHandler("FIXDEV-polyzone:exit", function(zone)
    if zone == "FIXDEV-foodchain:burgerjob_outsidenear" then
        TriggerEvent('FIXDEV-voice:setQuietMode', 'burgershot', false)
    end

    if zone == "FIXDEV-foodchain:burgerjob_intercom_outside" then
        -- TriggerEvent("FIXDEV:fiber:voice-event", "radioFrequency", 0)
        TriggerEvent('FIXDEV:fiber:voice-event', 'intercom', 85, 2, false)
        exports["FIXDEV-ui"]:sendAppEvent("hud", { burgerShotIntercom = false })
    end
...
AddEventHandler("FIXDEV-inventory:itemUsed", function(item)
  ...
  if not headsetConnected then
    ...
    TriggerEvent('FIXDEV:fiber:voice-event', 'intercom', 85, 1, true, true)
    exports["FIXDEV-ui"]:sendAppEvent("hud", { burgerShotIntercom = true })
else
    headsetConnected = false
    TriggerEvent('FIXDEV:fiber:voice-event', 'intercom', 85, 1, false, false)
    exports["FIXDEV-ui"]:sendAppEvent("hud", { burgerShotIntercom = false })
  end
end)

RegisterNetEvent('FIXDEV-inventory:itemCheck')
AddEventHandler('FIXDEV-inventory:itemCheck', function (item)
  if item ~= "burgershotheadset" or not headsetConnected then return end
  headsetConnected = false
  TriggerEvent('FIXDEV:fiber:voice-event', 'intercom', 85, 1, false, false)
end)

RegisterNetEvent('FIXDEV-foodchain:cash:in')
AddEventHandler('FIXDEV-foodchain:cash:in', function()
    local cid = exports["isPed"]:isPed("cid")
    TriggerServerEvent("FIXDEV-foodchain:update:pay", cid)
end)
...
exports["FIXDEV-polytarget"]:AddBoxZone("cash_in", vector3(241.67, 226.35, 106.29), 2.2, 1, {
    heading=0
  })
