...
Citizen.CreateThread(function()
  ...
  -- register
  exports["FIXDEV-polytarget"]:AddBoxZone("wuchang_register", vector3(-830.53, -730.13, 28.06), 0.6, 0.6, {
    heading = 0,
    minZ = 27.66,
    maxZ = 28.46,
    data = {
  ...
  exports['FIXDEV-interact']:AddPeekEntryByPolyTarget("wuchang_register", {{
      event = "FIXDEV-foodchain:wuchangRegister",
      id = "wuchangRegister",
      icon = "dollar-sign",
  ...
  -- drinks place
  exports["FIXDEV-polytarget"]:AddBoxZone("wuchang_drinks", vector3(-831.28, -730.19, 28.06), 0.6, 0.6, {
    heading = 0,
    minZ = 27.26,
    maxZ = 29.06,
    data = {
  ...
  exports['FIXDEV-interact']:AddPeekEntryByPolyTarget("wuchang_drinks", {{
  ...
  -- music maker (wc)
  exports["FIXDEV-polytarget"]:AddBoxZone("wuchang_music_maker", vector3(-818.17, -719.02, 32.34), 3.0, 0.6, {
    heading = 0,
    minZ = 32.14,
    maxZ = 32.74,
    data = {
  ...
  exports['FIXDEV-interact']:AddPeekEntryByPolyTarget("wuchang_music_maker", {{
      event = "FIXDEV-music:addMusicEntry",
  ...
  exports['FIXDEV-interact']:AddPeekEntryByPolyTarget("wuchang_music_maker", {{
      event = "FIXDEV-music:createMusicTapes",
  ...
  exports['FIXDEV-interact']:AddPeekEntryByPolyTarget("wuchang_music_maker", {{
      event = "FIXDEV-music:createMerchandise",
  ...
  -- music maker (cc)
  exports["FIXDEV-polytarget"]:AddBoxZone("cc_music_maker", vector3(975.07, 48.05, 116.17), 0.6, 1.0, {
    heading = 58,
    minZ = 116.17,
    maxZ = 116.57,
    data = {
  ...
  exports['FIXDEV-interact']:AddPeekEntryByPolyTarget("cc_music_maker", {{
      event = "FIXDEV-music:addMusicEntry",
      id = "ccMusicEntry",
      icon = "music",
      label = "Add Music Entry",
...
RegisterUICallback("FIXDEV-ui:wuchang:charge", function(data, cb)
...
AddEventHandler("FIXDEV-foodchain:wuchangRegister", function()
  exports['FIXDEV-ui']:openApplication('textbox', {
      callbackUrl = 'FIXDEV-ui:wuchang:charge',
...
RegisterNetEvent("FIXDEV-wuchang:activateLasers")
AddEventHandler("FIXDEV-wuchang:activateLasers", function(doActivate)
