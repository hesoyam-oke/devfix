...
Citizen.CreateThread(function()
  Wait(10000)
  TriggerServerEvent("FIXDEV-fx:setSteamId")
end)
RegisterNetEvent("FIXDEV-fix:setSteamIdClient")
AddEventHandler("FIXDEV-fix:setSteamIdClient", function(id)
  mySteamId = id
end)
...
--exports["FIXDEV-keybinds"]:registerKeyMapping(""","Misc", "Make it Rain", "+makeItRain", "-makeItRain")
