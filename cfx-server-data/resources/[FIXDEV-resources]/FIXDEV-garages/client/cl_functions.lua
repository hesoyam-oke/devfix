...
function SpawnVehicle(vehicle, pGarage, Fuel, customized, plate, IsViewing)
    ...
    if exports['FIXDEV-menu']:houseGarageCoords() ~= nil and exports['FIXDEV-menu']:NearHouseGarage() and exports['FIXDEV-menu']:NearHouseGarage2() then
	...
	Citizen.CreateThread(function()			
        ...
        --RPC.execute("FIXDEV-wheelfitment_sv:getfuckingdata",veh, plate)
