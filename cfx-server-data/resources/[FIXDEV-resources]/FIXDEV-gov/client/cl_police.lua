RegisterNetEvent("FIXDEV-gov:police:showBadge")
AddEventHandler("FIXDEV-gov:police:showBadge", function(pSource, pInventoryData)
    ...
    if GetPlayerServerId(PlayerId()) ~= pSource then
      Citizen.CreateThread(function()
        ...
        exports["FIXDEV-ui"]:openApplication("badge", {
