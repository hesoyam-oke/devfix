RegisterUICallback("FIXDEV-ui:getLicenses", function(data, cb)
...
RegisterUICallback("FIXDEV-ui:getAllLicenses", function(data, cb)
  local success, message = RPC.execute("GetAllLicenses")
  cb({ data = message, meta = { ok = success, message = 'done' }})
end)

RegisterUICallback("FIXDEV-ui:getCharacterPermissions", function(data, cb)
  local success, message = RPC.execute("GetStateAccess")
  cb({ data = message, meta = { ok = success, message = 'done' }})
end)

RegisterUICallback("FIXDEV-ui:getStateCharacterDetails", function(data, cb)
  local success, message = RPC.execute("GetCharacterDetails", data)
  cb({ data = message, meta = { ok = success, message = 'done' }})
end)

RegisterUICallback("FIXDEV-ui:revokeLicense", function(data, cb)
...
RegisterUICallback("FIXDEV-ui:grantLicense", function(data, cb)
