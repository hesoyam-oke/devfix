(() => {
    ...
    onNet("FIXDEV-graffiti:completePurchase", async (pId) => {
        let src = source
        let data = global.exports["FIXDEV-lib"].getCharacter(src)
    ...
    onNet("FIXDEV-graffiti:changeSpray", async (data, data2) => {
        console.log(data, data2)

    })

    onNet("FIXDEV-gangsystem:contestGraffiti", async (data, data2, data3) => {
        console.log(data, data2, data3)

    })

    onNet('FIXDEV-objects:requestObjects', async () => {
        let src = source,
        ...
        emitNet('FIXDEV-objects:loadObjects', src, requestGraffiti)
      })

    FYX.Procedures.register("FIXDEV-graffiti:spray", async (src, pModel, pCoords, pRotation, pGandId, pIsGang) => {
      ...
      let CurrGraffiti = {
        ...
        return emitNet('pFIXDEV:objects:prepareNewObject', -1, CurrGraffiti), true
    })
})();
