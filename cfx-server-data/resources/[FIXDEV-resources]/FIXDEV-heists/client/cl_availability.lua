RegisterNetEvent('FIXDEV-heists:checkAvailability')
AddEventHandler('FIXDEV-heists:checkAvailability', function() 
    ...
    exports["FIXDEV-interface"]:showContextMenu(FatCunt)
end)

RegisterNetEvent('FIXDEV-heists:purchaseHeistEquipment')
AddEventHandler('FIXDEV-heists:purchaseHeistEquipment', function()
    local HeistEquipment = {
		{
            ...
            children = {
                ...
                action = "FIXDEV-heists:purchaseGreenLaptop",
            },
        },
        {
            title = "Paleto Laptop",
            ...
            children = {
                ...
                action = "FIXDEV-heists:purchaseBlueLaptop",
            },
        },
    }
...
RegisterInterfaceCallback('FIXDEV-heists:purchaseGreenLaptop', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    if exports['FIXDEV-inventory']:hasEnoughOfItem('heistusb5', 1) then
        TriggerEvent('inventory:removeItem', 'heistusb5', 1)
        TriggerEvent("player:receiveItem", "heistlaptop3", 1)
    end
end)

RegisterInterfaceCallback('FIXDEV-heists:purchaseBlueLaptop', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    if exports['FIXDEV-inventory']:hasEnoughOfItem('heistusb1', 1) then
