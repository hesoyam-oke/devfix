...
RegisterInterfaceCallback('FIXDEV-fleeca:email_1', function(data, cb)
...
RegisterInterfaceCallback('FIXDEV-fleeca:email_2', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
...
RegisterInterfaceCallback('FIXDEV-fleeca:email_3', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
...
RegisterInterfaceCallback('FIXDEV-fleeca:email_4', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
...
RegisterInterfaceCallback('FIXDEV-fleeca:email_5', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
...
RegisterInterfaceCallback('FIXDEV-fleeca:email_6', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
...
RegisterNetEvent('FIXDEV-robbery:usb')
AddEventHandler('FIXDEV-robbery:usb', function()
    local ped = GetPlayerPed(-1)
    local pos = GetEntityCoords(ped)
                ...
                if dist < 1.5 then				
                    if not Config.SmallBanks[closestBank]["isOpened"] then 
                        if exports["isPed"]:isPed("countpolice") >= 0 then
                            TriggerServerEvent('FIXDEV-heists:fleecaBankLog')
                            TriggerServerEvent("FIXDEV-heists:availabilty")
                            exports["FIXDEV-dispatch"]:dispatchadd('10-90', "Fleeca Bank Robbery", "108")
...
RegisterNetEvent('FIXDEV-robbery:client:setBankState')
AddEventHandler('FIXDEV-robbery:client:setBankState', function(bankId, state)
...
RegisterNetEvent('FIXDEV-robbery:client:enableAllBankSecurity')
AddEventHandler('FIXDEV-robbery:client:enableAllBankSecurity', function()
    for k, v in pairs(Config.SmallBanks) do
        Config.SmallBanks[k]["alarm"] = true
    end
end)

RegisterNetEvent('FIXDEV-robbery:client:disableAllBankSecurity')
AddEventHandler('FIXDEV-robbery:client:disableAllBankSecurity', function()
    for k, v in pairs(Config.SmallBanks) do
        Config.SmallBanks[k]["alarm"] = false
    end
end)

RegisterNetEvent('FIXDEV-robbery:client:BankSecurity')
AddEventHandler('FIXDEV-robbery:client:BankSecurity', function(key, status)
...
RegisterNetEvent('FIXDEV-robbery:client:setLockerState')
AddEventHandler('FIXDEV-robbery:client:setLockerState', function(bankId, lockerId, state, bool)
    if bankId == "pacific" then	
        print('[QUEER]')
    else
...
RegisterNetEvent('FIXDEV-robbery:client:ResetFleecaLockers')
AddEventHandler('FIXDEV-robbery:client:ResetFleecaLockers', function(BankId)
...
RegisterNetEvent("fleeca:success:panel", function()
    ...
    exports["FIXDEV-dispatch"]:dispatchadd('10-90', "Fleeca Bank Robbery", "108")
    TriggerServerEvent('FIXDEV-robbery:server:setBankState', closestBank, true)

     if closestBank == 1 then
        print('[FIXDEV-heists] CREATE FLEECA PINK CAGE TROLLEYS')
        TriggerEvent('FIXDEV:create:props:trolleys:pink:cage:bank')
     elseif closestBank == 2 then
        print('[FIXDEV-heists] CREATE FLEECA LEGION SQUARE TROLLEYS')
        TriggerEvent('FIXDEV:create:props:trolleys:legion:sqaure:bank')
     elseif closestBank == 3 then
        print('[FIXDEV-heists] CREATE FLEECA HAWICK AVE TROLLEYS')
        TriggerEvent('FIXDEV:create:props:trolleys:hawick:ave:bank')
     elseif closestBank == 4 then
        print('[FIXDEV-heists] CREATE FLEECA DEL PERRO TROLLEYS')
        TriggerEvent('FIXDEV:create:props:trolleys:del:perrro:blvd')
     elseif closestBank == 5 then
        print('[FIXDEV-heists] CREATE FLEECA GREAT OCEAN TROLLEYS')
        TriggerEvent('FIXDEV:create:props:trolleys:great:ocean:highway')
     elseif closestBank == 6 then
        print('[FIXDEV-heists] CREATE FLEECA ROUTE 68 TROLLEYS')
        TriggerEvent('FIXDEV:create:props:trolleys:route:68:bank')
     end
     DeleteObject(laptop)
 end)
...
AddEventHandler("fleeca:loot", function()
    local card = exports["FIXDEV-taskbar"]:taskBar(40000,"Taking cash...")
    if card == 100 then
...
RegisterNetEvent('FIXDEV:create:props:trolleys:legion:sqaure:bank')
AddEventHandler('FIXDEV:create:props:trolleys:legion:sqaure:bank', function()
...
RegisterNetEvent('FIXDEV:create:props:trolleys:del:perrro:blvd')
AddEventHandler('FIXDEV:create:props:trolleys:del:perrro:blvd', function()
...
RegisterNetEvent('FIXDEV:create:props:trolleys:great:ocean:highway')
AddEventHandler('FIXDEV:create:props:trolleys:great:ocean:highway', function()
...
RegisterNetEvent('FIXDEV:create:props:trolleys:pink:cage:bank')
AddEventHandler('FIXDEV:create:props:trolleys:pink:cage:bank', function()
...
RegisterNetEvent('FIXDEV:create:props:trolleys:hawick:ave:bank')
AddEventHandler('FIXDEV:create:props:trolleys:hawick:ave:bank', function()
...
RegisterNetEvent('FIXDEV:create:props:trolleys:route:68:bank')
AddEventHandler('FIXDEV:create:props:trolleys:route:68:bank', function()
...
RegisterNetEvent("FIXDEV-fleeca:grab")
AddEventHandler("FIXDEV-fleeca:grab", function()
