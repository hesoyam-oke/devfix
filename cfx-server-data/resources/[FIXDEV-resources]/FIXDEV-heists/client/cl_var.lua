RegisterNetEvent('FIXDEV-heists:door_thermite')
AddEventHandler('FIXDEV-heists:door_thermite', function()
    TriggerServerEvent('FIXDEV-heists:thermite_var')
end)

RegisterNetEvent('FIXDEV-heists:var_door_to_lobby')
AddEventHandler('FIXDEV-heists:var_door_to_lobby', function()
    local player = GetEntityCoords(PlayerPedId())
    local distance = #(vector3(-209.2301, -303.5382, 74.482246) - player)
    if distance < 1.5 then
        if exports["FIXDEV-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
            TriggerEvent('FIXDEV-hud:show_hackerman')
            LobbyDoor()
            exports['FIXDEV-thermite']:OpenThermiteGame(function(success)
                if success then
                    TriggerServerEvent('FIXDEV-heists:var_thermite')
                    TriggerEvent('FIXDEV-hud:hide_hackerman')
                    TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                    TriggerServerEvent('FIXDEV-doors:change-lock-state', 575, false) 
                    Citizen.Wait(3000)
...
AddEventHandler("FIXDEV-inventory:itemUsed", function(item)
    if item == "thermitecharge" then
        TriggerEvent('FIXDEV-heists:var_door_to_lobby')
    end
end)
...
exports["FIXDEV-polytarget"]:AddCircleZone("var_computer_1",  vector3(-212.7, -298.21, 74.49), 0.35, {
    useZ = true
})

exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("var_computer_1", {
    {
        event = "FIXDEV-heists:var_event_1",
        id = "var_computer_1",
        icon = "user-secret",
...
RegisterNetEvent('FIXDEV-heists:var_event_1')
AddEventHandler('FIXDEV-heists:var_event_1', function()
    TriggerServerEvent('FIXDEV-heists:in_var_1_srv')
end)

RegisterNetEvent('FIXDEV-heists:enter_var_location_1')
AddEventHandler('FIXDEV-heists:enter_var_location_1', function()
    if exports['FIXDEV-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
...
exports["FIXDEV-polytarget"]:AddCircleZone("var_computer_2",  vector3(-211.2, -301.14, 74.49), 0.45, {
    useZ = true
})

exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("var_computer_2", {
    {
        event = "FIXDEV-heists:var_event_2",
        id = "var_computer_2",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('FIXDEV-heists:var_event_2')
AddEventHandler('FIXDEV-heists:var_event_2', function()
    TriggerServerEvent('FIXDEV-heists:in_var_2_srv')
end)

RegisterNetEvent('FIXDEV-heists:enter_var_location_2')
AddEventHandler('FIXDEV-heists:enter_var_location_2', function()
    if exports['FIXDEV-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
exports["FIXDEV-polytarget"]:AddCircleZone("var_computer_3",  vector3(-206.6, -297.19, 74.49), 0.45, {
    useZ = true
})

exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("var_computer_3", {
    {
        event = "FIXDEV-heists:var_event_3",
        id = "var_computer_3",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('FIXDEV-heists:var_event_3')
AddEventHandler('FIXDEV-heists:var_event_3', function()
    TriggerServerEvent('FIXDEV-heists:in_var_3_srv')
end)

RegisterNetEvent('FIXDEV-heists:enter_var_location_3')
AddEventHandler('FIXDEV-heists:enter_var_location_3', function()
    if exports['FIXDEV-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
exports["FIXDEV-polytarget"]:AddCircleZone("var_computer_4",  vector3(-207.02, -294.14, 74.49), 0.5, {
    useZ = true
})

exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("var_computer_4", {
    {
        event = "FIXDEV-heists:var_event_4",
        id = "var_computer_4",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('FIXDEV-heists:var_event_4')
AddEventHandler('FIXDEV-heists:var_event_4', function()
    TriggerServerEvent('FIXDEV-heists:in_var_4_srv')
end)

RegisterNetEvent('FIXDEV-heists:enter_var_location_4')
AddEventHandler('FIXDEV-heists:enter_var_location_4', function()
    if exports['FIXDEV-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
exports["FIXDEV-polytarget"]:AddCircleZone("var_computer_5",  vector3(-209.4, -293.28, 74.49), 0.4, {
    useZ = true
})

exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("var_computer_5", {
    {
        event = "FIXDEV-heists:var_event_5",
        id = "var_computer_5",
        icon = "user-secret",
        label = "Access VAR Environment",
        parameters = {},
...
RegisterNetEvent('FIXDEV-heists:var_event_5')
AddEventHandler('FIXDEV-heists:var_event_5', function()
    TriggerServerEvent('FIXDEV-heists:in_var_5_srv')
end)

RegisterNetEvent('FIXDEV-heists:enter_var_location_5')
AddEventHandler('FIXDEV-heists:enter_var_location_5', function()
    if exports['FIXDEV-inventory']:hasEnoughOfItem('varhelmet', 1) then
        isPlayerInVar = 1
        DoScreenFadeOut(1)
        SetEntityCoords(PlayerPedId(), 2154.5913, 2921.1772, -81.07546)
...
AddEventHandler('varhack:1', function()
    exports['FIXDEV-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('FIXDEV-heists:hackfalse')
        else
...
TriggerServerEvent('FIXDEV-heists:hack1')
end)


exports["FIXDEV-polytarget"]:AddCircleZone("var_hack1",  vector3(2167.94, 2925.92, -81.38), 0.5, {
    useZ = true
})


exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("var_hack1", {
    {
...
AddEventHandler('varhack:2', function()
    exports['FIXDEV-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('FIXDEV-heists:hackfalse2')
          print("working?")
        else
            TriggerEvent('voidrp:varcreatepedfail1')
          print("lol")
...
TriggerServerEvent('FIXDEV-heists:hack2')
end)

exports["FIXDEV-polytarget"]:AddCircleZone("var_hack2",  vector3(2135.66, 2901.72, -84.27), 0.53, {
    useZ = true
})


exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("var_hack2", {
    {
...
AddEventHandler('varhack:3', function()
    exports['FIXDEV-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('FIXDEV-heists:hackfalse3')
          print("working?")
        else
...
TriggerServerEvent('FIXDEV-heists:hack3')
end)

exports["FIXDEV-polytarget"]:AddCircleZone("var_hack3",  vector3(2171.24, 2927.76, -81.38), 0.41, {
    useZ = true
})


exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("var_hack3", {
    {
...
AddEventHandler('varhack:4', function()
    exports['FIXDEV-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('voidrp:varcreateped')
            TriggerServerEvent('FIXDEV-heists:hackfalse4')
          print("working?")
        else
            TriggerEvent('voidrp:varcreatepedfail2')
          print("basarisiz")
...
TriggerServerEvent('FIXDEV-heists:hack4')
end)

exports["FIXDEV-polytarget"]:AddCircleZone("var_hack4",  vector3(2087.82, 2946.72, -84.22), 0.53, {
    useZ = true
})


exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("var_hack4", {
    {
...
AddEventHandler('varhack:5', function()
    exports['FIXDEV-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('voidrp:varcreateped2')
            TriggerServerEvent('FIXDEV-heists:hackfalse5')
          print("working?")
        else
...
TriggerServerEvent('FIXDEV-heists:hack5')
end)

exports["FIXDEV-polytarget"]:AddCircleZone("var_hack5",  vector3(2174.89, 2927.76, -81.38), 0.4, {
    useZ = true
})

exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("var_hack5", {
    {
...
AddEventHandler('varhack:6', function()
    exports['FIXDEV-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerServerEvent('FIXDEV-heists:hackfalse6')
          print("working?")
        else
            TriggerEvent('voidrp:varcreatepedfail')
          print("basarisiz")
...
TriggerServerEvent('FIXDEV-heists:hack6')
end)

exports["FIXDEV-polytarget"]:AddCircleZone("var_hack6",  vector3(2327.77, 2945.95, -84.47), 0.55, {
    useZ = true
})

exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("var_hack6", {
    {
...
AddEventHandler('varhack:7', function()
    exports['FIXDEV-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('voidrp:varcreateped2')
            TriggerServerEvent('FIXDEV-heists:hackfalse7')
...
if exports["FIXDEV-inventory"]:hasEnoughOfItem("varusb", 1) then
TriggerServerEvent('FIXDEV-heists:hack7')
end 
end)

exports["FIXDEV-polytarget"]:AddCircleZone("var_hack7",  vector3(2185.9, 2913.24, -84.8), 0.5, {
    useZ = true
})

exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("var_hack7", {
    {
...
AddEventHandler('varhack:8', function()
    exports['FIXDEV-slider']:OpenSliderGame(function(success)
        if success then
            ...
            TriggerEvent('voidrp:varcreateped')
            TriggerServerEvent('FIXDEV-heists:hackfalse8')
            TriggerEvent("inventory:removeItem", "varusb", 1)
...
if exports["FIXDEV-inventory"]:hasEnoughOfItem("varusb", 1) then
TriggerServerEvent('FIXDEV-heists:hack8')
end 
end)

exports["FIXDEV-polytarget"]:AddCircleZone("var_hack8",  vector3(2185.94, 2928.69, -84.8), 0.5, {
    useZ = true
})

exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("var_hack8", {
    {
...
exports["FIXDEV-polytarget"]:AddCircleZone("leave",  vector3(2156.4, 2922.22, -81.08), 0.5, {
    useZ = true
})

exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("leave", {
    {
...
TriggerServerEvent('FIXDEV-leavevar2')
end)
...
AddEventHandler('voidrp:varcreateped', function()
	...
	pedsilinsin = CreatePed(pedType, hashKey, 2126.529, 2925.3417, -84.79316, 264.17858, true, false)
...
AddEventHandler('voidrp:varcreateped2', function()
    ...
    AddRelationshipGroup('lumo')
	pedsilinsin = CreatePed(pedType, hashKey, 2209.0737, 2920.9702, -84.80446, 83.676605, true, false)
...
AddEventHandler('voidrp:varcreateped3', function()
    ...
    AddRelationshipGroup('lumo')
	pedsilinsin = CreatePed(pedType, hashKey, 2072.3735, 2949.8503, -84.80004, 261.04425, true, false)
...
AddEventHandler('voidrp:varcreatepedfail1', function()
    ...
    AddRelationshipGroup('lumo')
	pedsilinsin = CreatePed(pedType, hashKey, 2357.446, 2898.3159, -84.80004, 88.009696, true, false)
...
AddEventHandler('voidrp:varcreatepedfail2', function()
    ...
    AddRelationshipGroup('lumo')
	pedsilinsin = CreatePed(pedType, hashKey, 1978.2264, 2925.2519, -84.79316, 268.59841, true, false)
...
AddEventHandler('exit:varcompleteheist', function()
  ...
  TriggerEvent('FIXDEV:admin:ReviveInDistance')
  Citizen.Wait(1000)
end)
...
RegisterNetEvent('FIXDEV-heists:loot_peds')
AddEventHandler('FIXDEV-heists:loot_peds', function()
...
RegisterNetEvent('FIXDEV-heists:var_loot_ped')
AddEventHandler('FIXDEV-heists:var_loot_ped', function()
    if isPlayerInVar == 1 then
        TriggerEvent('FIXDEV-heists:loot_peds')
        TriggerServerEvent('FIXDEV-var:lootcooldown')
    else
        print('cooldown')
    end
end)

RegisterNetEvent('FIXDEV-heists:svclientloot')
AddEventHandler('FIXDEV-heists:svclientloot', function()
    TriggerServerEvent('FIXDEV-evannicxvar:varlootcooldown')
end)

function removevarmedkits()
    local qty = exports["FIXDEV-inventory"]:getQuantity("varmedkit")
  ...
  function removevpistolammo()
    local qty = exports["FIXDEV-inventory"]:getQuantity("pistolammo")
    if qty and qty > 0 then
  ...
  function removevsubammo()
    local qty = exports["FIXDEV-inventory"]:getQuantity("subammo")
    if qty and qty > 0 then
  ...
  function removevrifleammo()
    local qty = exports["FIXDEV-inventory"]:getQuantity("rifleammo")
    if qty and qty > 0 then
