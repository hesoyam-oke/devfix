...
AddEventHandler("FIXDEV-inventory:itemUsed", function(pItem)
    if pItem == "thermitecharge" then
        TriggerEvent('FIXDEV-vault:firstdoor')
        TriggerEvent('FIXDEV-vault:seconddoor')
        TriggerEvent('FIXDEV-vault:lowerfirstdoor')
        TriggerEvent('FIXDEV-vault:lowerseconddoor')
    elseif pItem == "heistlaptop4" then
        TriggerEvent('FIXDEV-vault:startlowervault')
        TriggerEvent('FIXDEV-vault:startvault')
    end
end)

RegisterNetEvent('FIXDEV-vault:firstdoor')
AddEventHandler('FIXDEV-vault:firstdoor', function()
    ...
    if exports["isPed"]:isPed("countpolice") >= 0 then
        if distance < 1.5 then
            if exports["FIXDEV-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                TriggerServerEvent('FIXDEV-heists:vaultRobberyLog')
                ...
                exports['FIXDEV-thermite']:OpenThermiteGame(function(success)
                    if success then
                        ...
                        TriggerServerEvent('FIXDEV-doors:change-lock-state', 46, false) 
                        Citizen.Wait(3000)
...
RegisterNetEvent('FIXDEV-vault:seconddoor')
AddEventHandler('FIXDEV-vault:seconddoor', function()
    local player = GetEntityCoords(PlayerPedId())
            ...
            if exports["FIXDEV-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                ...
                exports['FIXDEV-thermite']:OpenThermiteGame(function(success)
                    if success then
                        ...
                        TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                        TriggerServerEvent('FIXDEV-doors:change-lock-state', 48, false) 
                        Citizen.Wait(3000)
                        FreezeEntityPosition(PlayerPedId(), false)
                    else
                        TriggerEvent('inventory:removeItem', 'thermitecharge', 1)
...
RegisterNetEvent('FIXDEV-vault:startvault')
AddEventHandler('FIXDEV-vault:startvault', function()
    local player = GetEntityCoords(PlayerPedId())
        ...
        if distance < 1.5 then
            if exports["FIXDEV-inventory"]:hasEnoughOfItem("heistlaptop4", 1) then
                ...
                function()
                    ...
                    TriggerEvent('FIXDEV-heists:vault_door')
                    DeleteObject(bag)
                    DeleteObject(laptop)
...
RegisterNetEvent('FIXDEV-heists:vault_door')
AddEventHandler('FIXDEV-heists:vault_door', function()
    TriggerEvent('vault:success:panel', closestBank, true)
    CreatenBrakeCrates()
end)

RegisterNetEvent('FIXDEV-vault:lowerfirstdoor')
AddEventHandler('FIXDEV-vault:lowerfirstdoor', function()
    local player = GetEntityCoords(PlayerPedId())
            ...
            if exports["FIXDEV-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                ...
                exports['FIXDEV-thermite']:OpenThermiteGame(function(success)
                    if success then
                        ...
                        TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                        TriggerServerEvent('FIXDEV-doors:change-lock-state', 49, false) 
                        Citizen.Wait(3000)
                        FreezeEntityPosition(PlayerPedId(), false)
                    else
                        TriggerEvent('inventory:removeItem', 'thermitecharge', 1)
...
RegisterNetEvent('FIXDEV-vault:lowerseconddoor')
AddEventHandler('FIXDEV-vault:lowerseconddoor', function()
    local player = GetEntityCoords(PlayerPedId())
            ...
            if exports["FIXDEV-inventory"]:hasEnoughOfItem("thermitecharge", 1) then
                ...
                exports['FIXDEV-thermite']:OpenThermiteGame(function(success)
                    if success then
                        ...
                        TriggerEvent("inventory:removeItem", "thermitecharge", 1)
                        TriggerServerEvent('FIXDEV-doors:change-lock-state', 50, false) 
                        Citizen.Wait(3000)
                        FreezeEntityPosition(PlayerPedId(), false)
                    else
                        TriggerEvent('inventory:removeItem', 'thermitecharge', 1)
...
RegisterNetEvent("FIXDEV-vault:grab", function()
...
exports["FIXDEV-polytarget"]:AddCircleZone("np_vault_lower_interact_1",  vector3(289.29, 227.55, 98.24), 0.25, {
    useZ = true
})

exports["FIXDEV-polytarget"]:AddCircleZone("np_vault_lower_interact_2",  vector3(286.92, 227.39, 98.29), 0.2, {
    useZ = true
})

exports["FIXDEV-polytarget"]:AddCircleZone("np_vault_lower_interact_3", vector3(284.69, 221.64, 98.24), 0.2, {
    useZ = true
})

exports["FIXDEV-polytarget"]:AddCircleZone("np_vault_lower_interact_4", vector3(286.52, 220.06, 98.29), 0.25, {
    useZ = true
})


exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("np_vault_lower_interact_1", {{
    event = "FIXDEV-vaultrob:lower:firstpindoor",
...
exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("np_vault_lower_interact_2", {{
    event = "FIXDEV-vaultrob:lower:secpindoor",
...
exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("np_vault_lower_interact_3", {{
    event = "FIXDEV-vaultrob:lower:thirdpindoor",
...
exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("np_vault_lower_interact_4", {{
    event = "FIXDEV-vaultrob:lower:fourthpindoor",
...
RegisterNetEvent('FIXDEV-loot_gold_tray')
AddEventHandler('FIXDEV-loot_gold_tray', function()
    TriggerServerEvent('FIXDEV-heists:loot_tray')
end)

RegisterNetEvent('FIXDEV-loot_cash_tray')
AddEventHandler('FIXDEV-loot_cash_tray', function()
    TriggerServerEvent('FIXDEV-heists:cash_tray')
end)

RegisterNetEvent("FIXDEV-heists:grab_from_tray")
AddEventHandler("FIXDEV-heists:grab_from_tray", function()
    local chance = math.random(120)
    Loot()
    if chance < 25 then
