...
local function loopSkill(count)
    ...
    while loopCount < count do
        ...
        local finished = exports["FIXDEV-ui"]:taskBarSkill(math.random(1400, 5000), math.random(7, 12))
...
AddEventHandler("FIXDEV-heists:breakInToRegister", function(pArgs, pEntity)
...
Citizen.CreateThread(function()
  exports["FIXDEV-interact"]:AddPeekEntryByModel({ 303280717 }, {{
    event = "FIXDEV-heists:breakInToRegister",
    id = "FIXDEV-heists:breakInToRegister",
    icon = "hammer",
    label = "Smash!",
    parameters = {},
  }}, {
