...
MinigameResult = nil
MinigameUICallbackUrl = "FIXDEV-ui:heistsPanelMinigameResult"
...
function UseBankPanel(panelCoords, panelHeading, location, withholdEmail)
    ...
    Citizen.CreateThread(function()
        ...
        TriggerServerEvent("FIXDEV-heists:hack:track", MinigameResult, "laptop")
...
function LoopSkill(count)
    ...
    while loopCount < count do
        ...
        local finished = exports["FIXDEV-ui"]:taskBarSkill(math.random(1000, 4000), math.random(7, 12))
...
function ThermiteCharge(loc, ptfx, rotplus, gameSettings)
  ...
  Citizen.CreateThread(function()
    ...
    TriggerServerEvent("FIXDEV-heists:hack:track", thermiteMinigameResult, "thermite")
...
local minigamePracUICallbackUrl = "FIXDEV-ui:heistsPanelMinigameResultPrac"
...
AddEventHandler("FIXDEV-inventory:itemUsed", function(item)
  ...
  if minigamePracResult then
    TriggerServerEvent("FIXDEV-heists:hack:success", 1)
  end
end)

AddEventHandler("FIXDEV-heists:purchasePracticeLaptop", function()
  RPC.execute("FIXDEV-heists:purchasePracticeLaptop")
end)
