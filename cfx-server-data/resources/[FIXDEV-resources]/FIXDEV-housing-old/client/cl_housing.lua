...
Citizen.CreateThread(function()
    while true do
        ...
        if insidehouse == true then
            ...
            --         -- exports["FIXDEV-ui"]:showInteraction("Enter", "classic")
            ...
            elseif clothing["x"] ~= 0.0 and #(vector3(clothing["x"],clothing["y"],clothing["z"]-0.3) - plyCoords) < 1.5 then
                ...
                TriggerEvent('FIXDEV-clothing:OutfitsActive', true)
                    -- DrawText3Ds( clothing["x"],clothing["y"],clothing["z"] , '/outfits to change clothing' )
                exports["FIXDEV-ui"]:showInteraction("Outfits", "classic")
            -- else
            --         TriggerEvent('FIXDEV-clothing:OutfitsActive', false)
            --         exports["FIXDEV-ui"]:hideInteraction("classic")
            --     end
            -- end
            ...
            elseif storage["x"] ~= 0.0 and #(vector3(storage["x"],storage["y"],storage["z"]-0.3) - plyCoords) < 1.5 then
                ...
                exports["FIXDEV-ui"]:showInteraction("[E] Stash", "classic")
                if IsControlJustReleased(2, 38) then
...
AddEventHandler('housing:exit:backdoor', function(x,y,z,h)
	...
	TriggerEvent("FIXDEV-weathersync:client:EnableSync")
	myhouseid = 0
	myhousetype = 0
	entryType = 0
end)
...
AddEventHandler("house:entersuccess", function(house_id,house_model,furniture, x,y,z)
	...
	TriggerEvent('FIXDEV-weathersync:client:DisableSync')
...
RegisterNetEvent('FIXDEV-motels:RealtorPay')
AddEventHandler('FIXDEV-motels:RealtorPay', function(amount)
