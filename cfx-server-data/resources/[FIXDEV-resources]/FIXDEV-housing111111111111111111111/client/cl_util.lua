...
function canRent()
    ...
    if isComplete and dist <= 3.0 then
        ...
        local canRent = RPC.execute("FIXDEV-housing:canRent", propertyId)
...
AddEventHandler("FIXDEV-housing:handler", function(data, cb)
...
Citizen.CreateThread(function()
    exports["FIXDEV-keybinds"]:registerKeyMapping("","Housing", "Interact", "+propertyInteract", "-propertyInteract", "E")
