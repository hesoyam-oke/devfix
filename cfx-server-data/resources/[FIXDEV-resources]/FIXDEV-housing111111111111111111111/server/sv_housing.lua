...
RPC.register("FIXDEV-phone:giveKey", function(src, pHouseId, pPlayerId)
    ...
    TriggerClientEvent("FIXDEV-phone:notification", pPlayerId, "fas FIXDEV-key", "Keys", "Você recebeu a chave da propriedade " .. Housing.info[pHouseId]["street"], 5000)
...
AddEventHandler('FIXDEV-housing:buyLog', function(pHouse, price)
    ...
    PerformHttpRequest("https://discord.com/api/webhooks/1012082840038555690/uBrYz4sosUN9pwxpHI6h13f87WB8HQzvUcVFPhXTI6xJOsvsbltkRUGccok-4ICS51PG", function(err, text, headers) end, 'POST', json.encode({username = "FIXDEV | House Bought Log", embeds = connect, avatar_url = "https://i.imgur.com/hMqEEQp.png"}), { ['Content-Type'] = 'application/json' })
end)