...
RegisterNetEvent("FIXDEV-hud:EnableHud", function(status)
    isLoggedIn = status
    if status == true then
        exports['FIXDEV-ui']:showInteraction('[F] To pay respects')
        HudActive = false
    end
end)
...
RegisterCommand('ui-r', function()
    ...
    exports['FIXDEV-ui']:showInteraction("Restarting UI .")
    Wait(1000)
    exports['FIXDEV-ui']:showInteraction("Restarting UI ..")
    Wait(1000)
    exports['FIXDEV-ui']:showInteraction("Restarting UI ...")
    Wait(1000)
    exports['FIXDEV-ui']:showInteraction("UI Successfully Restarted")
    Wait(1000)
    exports['FIXDEV-ui']:hideInteraction()
