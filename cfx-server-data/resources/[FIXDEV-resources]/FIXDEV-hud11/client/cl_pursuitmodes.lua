...
TriggerEvent("FIXDEV-hud:pursuit_values", SelectedPursuitMode)
SendNUIMessage({action = "pursuitmode", pursuitmode = SelectedPursuitMode})

 ]]
Citizen.CreateThread(function()
    exports["FIXDEV-keybinds"]:registerKeyMapping("", "Pursuit Modes", "Change Mode", "pursuit", "")
end)
