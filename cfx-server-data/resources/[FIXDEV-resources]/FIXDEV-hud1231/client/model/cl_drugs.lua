...
AddEventHandler('hadsugar', function()
  ...
  drugEffectTime = 0
  TriggerEvent('FIXDEV-hud:hidedrugs')
...
AddEventHandler('inventory:ketamine', function(pPurity)
  ...
  TriggerServerEvent("FIXDEV-drugeffects:forceStress", 1, 3 * 60 * 1000)
  ...
  ketaActive = false
  TriggerEvent("fx:run", "cocaine", 10, 0.0, false, false)
  TriggerServerEvent("FIXDEV-drugeffects:forceStress", 5000, 10 * 60 * 1000)
end)
