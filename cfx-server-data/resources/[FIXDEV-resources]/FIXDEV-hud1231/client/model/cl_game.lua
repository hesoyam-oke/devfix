...
-- RegisterNetEvent("FIXDEV-hud:initHud")
-- AddEventHandler("FIXDEV-hud:initHud", function()
--   print("[FIXDEV-hud] Init hud...")
...
-- RegisterNetEvent('FIXDEV-admin:maxstats')
-- AddEventHandler('FIXDEV-admin:maxstats', function()
--     currentValues["thirst"] = 100
--     currentValues["hunger"] = 100 
