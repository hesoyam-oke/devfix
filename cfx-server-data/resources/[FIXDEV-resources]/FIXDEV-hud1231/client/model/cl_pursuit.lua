...
RegisterNetEvent("FIXDEV-hud:pursuit_mode_a")
AddEventHandler("FIXDEV-hud:pursuit_mode_a",function()
...
RegisterNetEvent("FIXDEV-hud:pursuit_mode_b") -- Second Pursuit Mode
AddEventHandler("FIXDEV-hud:pursuit_mode_b",function()
	local ped = PlayerPedId()
	if (IsPedInAnyVehicle(PlayerPedId(), true)) then
		local veh = GetVehiclePedIsIn(PlayerPedId(),false)  
		local Driver = GetPedInVehicleSeat(veh, -1)
...
RegisterNetEvent("FIXDEV-hud:pursuit_mode_s")  -- Final Pursuit Mode for now anyways 0_o
AddEventHandler("FIXDEV-hud:pursuit_mode_s",function()
    local ped = PlayerPedId()
	if (IsPedInAnyVehicle(PlayerPedId(), true)) then
		local veh = GetVehiclePedIsIn(PlayerPedId(),false)  
		local Driver = GetPedInVehicleSeat(veh, -1)
...
RegisterNetEvent("FIXDEV-hud:pursuit_mode_off")
AddEventHandler("FIXDEV-hud:pursuit_mode_off",function()
local ped = PlayerPedId()
if (IsPedInAnyVehicle(PlayerPedId(), true)) then
	local veh = GetVehiclePedIsIn(PlayerPedId(),false)  
	local Driver = GetPedInVehicleSeat(veh, -1)
