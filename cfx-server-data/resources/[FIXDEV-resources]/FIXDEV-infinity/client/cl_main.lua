...
TriggerServerEvent("FIXDEV:infinity:player:ready")

RegisterNetEvent('FIXDEV:infinity:player:coords')
AddEventHandler('FIXDEV:infinity:player:coords', function (pCoords)
    PlayerCoords = pCoords
end)

RegisterNetEvent('FIXDEV:infinity:entity:coords')
AddEventHandler('FIXDEV:infinity:entity:coords', function (pNetId, pCoords)
...
function FetchEntityCoords(pNetId)
    ...
    TriggerServerEvent('FIXDEV:infinity:entity:coords', pNetId)
