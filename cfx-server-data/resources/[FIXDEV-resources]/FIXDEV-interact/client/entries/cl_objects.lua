...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            return not exports['FIXDEV-fuel']:hasNozle()
        end
    }
}
...
Entries[#Entries + 1] = {
    ...
    options = {
        distance = { radius = 1.7 },
        isEnabled = function(pEntity, pContext)
            return exports['FIXDEV-fuel']:hasNozle()
        end
    }
}
    ...
    data = {
        {
            ...
            label = "Weights",
            icon = "circle",
            event = "FIXDEV-healthcare:exercise",
            parameters = {}
        }
    },
    options = {
...
--             label = "Smoke Machine",
--             icon = "circle",
--             event = "FIXDEV-stripclub:smokemachine",
--             parameters = {}
--         }
--     },
--     options = {
    ...
    data = {
        {
            ...
            label = "Steal!",
            icon = "hammer",
            event = "FIXDEV-usableprops:stealStopSign",
            parameters = {}
        }
    },
    options = {
...
--[[Entries[#Entries + 1] = {
    ...
    data = {
        {
            id = 'FIXDEV-usableprops:stealStopSign',
            label = "Steal!",
            icon = "hammer",
            event = "FIXDEV-usableprops:stealStopSign",
            parameters = {}
  ...
  data = {
      {
          ...
          icon = "archive",
          event = "FIXDEV-beekeeping:checkBeehive",
          parameters = {}
      }
  },
  options = {
  ...
  data = {
      {
          ...
          event = "FIXDEV-beekeeping:harvestHive",
          parameters = {}
      }
  },
  options = {
