...
Entries[#Entries + 1] = {
    ...
    options = {
        distance = { radius = 1.8 },
        isEnabled = function(pEntity, pContext)
            return exports['FIXDEV-activities']:canHandOffPackages() and exports['FIXDEV-inventory']:hasEnoughOfItem('darkmarketpackage', 1)
        end
    }
}
    ...
    data = {
        {
            ...
            icon = "gas-pump",
            event = "FIXDEV-fuel:RefillVehicle",
            parameters = {}
        }
    },
    options = {
    ...
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            return (not (isCloseToHood(pEntity, PlayerPedId()) or isCloseToBoot(pEntity, PlayerPedId(), 2.0, pContext.model))
              or pContext.model == GetHashKey("emsnspeedo"))
              and not IsPedInAnyVehicle(PlayerPedId(), false)
              and NetworkGetEntityIsNetworked(pEntity) and exports['FIXDEV-boosting']:pCanFinishScratch()
        end
    }
}
    ...
    data = {
        {
            ...
            icon = "wheelchair",
            event = "FIXDEV:vehicle:wheelchair:control",
            parameters = {}
        }
    },
    options = {
