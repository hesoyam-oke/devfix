...
RegisterNetEvent("FIXDEV-interface:open-application")
AddEventHandler("FIXDEV-interface:open-application", openApplication)
...
function closeApplication(app, data)
  ...
  TriggerEvent("FIXDEV-interface:application-closed", app, { fromEscape = false })
end
...
RegisterNetEvent("FIXDEV-interface:soundPlay")
AddEventHandler("FIXDEV-interface:soundPlay", function(name, volume, loop)
