...
RegisterNetEvent('FIXDEV-dumpster')
AddEventHandler('FIXDEV-dumpster', function() 
            ...
            for i = 1, #searched do
                ...
                elseif i == #searched and not dumpsterFound then
                    ...
                    if (finished == 100) then 
                        ...
                        local finished = exports ['FIXDEV-taskbar']:taskBar(25000, 'Searching Dumpster')
                        if (finished ==100) then
...
RegisterNetEvent('FIXDEV-dumpster2')
AddEventHandler('FIXDEV-dumpster2', function() 
    local ped = PlayerPedId()
    local pos = GetEntityCoords(ped)
    local dumpsterFound = false
        ...
        if GetDistanceBetweenCoords(pos.x, pos.y, pos.z, dumpPos.x, dumpPos.y, dumpPos.z, true) then
            ...
            for i = 1, #searched do
                ...
                elseif i == #searched and not dumpsterFound then
                    ...
                    TaskPlayAnim(PlayerPedId(), dict, 'base', 3.0, -8, -1, 63, 0, 0, 0, 0 )
                    ::skill::
                    local skillfinished = exports["FIXDEV-skillbar"]:taskBar(1)
...
RegisterNetEvent('FIXDEV-dumpster3')
AddEventHandler('FIXDEV-dumpster3', function() 
    local ped = PlayerPedId()
    local pos = GetEntityCoords(ped)
    local dumpsterFound = false
            ...
            for i = 1, #searched do
                ...
                elseif i == #searched and not dumpsterFound then
                    ...
                    if skillfinished then
                        ...
                        local finished = exports ['FIXDEV-taskbar']:taskBar(15000, 'Searching Dumpster')
                        if (finished ==100) then
                            TriggerServerEvent('erp:giveDumpsterReward')
