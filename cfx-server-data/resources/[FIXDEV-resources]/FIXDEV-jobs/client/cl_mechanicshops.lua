...
AddEventHandler('FIXDEV-polyzone:enter', function(name)
    if name == "tuner_shop_craft" then
        ...
        TunerCraft()
        local isEmployed = exports["FIXDEV-business"]:IsEmployedAt("tuner_shop")
        if isEmployed then
...
AddEventHandler('FIXDEV-polyzone:enter', function(name)
    if name == "harmony_repairs_craft" then
        Harmony_Craft = true     
        HarmonyCraft()
        local isEmployed = exports["FIXDEV-business"]:IsEmployedAt("harmony_repairs")
        if isEmployed then
            exports['FIXDEV-ui']:showInteraction("[E] Craft")
        end
...
AddEventHandler('FIXDEV-polyzone:enter', function(name)
    if name == "hayes_autos_craft" then
        Hayes_Craft = true     
        HayesCraft()
        local isEmployed = exports["FIXDEV-business"]:IsEmployedAt("hayes_autos")
        if isEmployed then
            exports['FIXDEV-ui']:showInteraction("[E] Craft")
        end
...
AddEventHandler('FIXDEV-polyzone:enter', function(name)
    if name == "ottos_autos_craft" then
        ...
        OttosCraft()
        local isEmployed = exports["FIXDEV-business"]:IsEmployedAt("ottos_autos")
        if isEmployed then
            exports['FIXDEV-ui']:showInteraction("[E] Craft")
        end
...
Citizen.CreateThread(function()
    -- Tuner Shop | Start --
    exports["FIXDEV-polyzone"]:AddBoxZone("tuner_shop_stash", vector3(128.46, -3014.08, 7.04), 2.5, 2.5, {
    ...
    exports["FIXDEV-polyzone"]:AddBoxZone("tuner_shop_craft", vector3(143.96, -3051.26, 7.04), 1, 5, {
    ...
    exports["FIXDEV-polyzone"]:AddBoxZone("harmony_repairs_stash", vector3(1187.12, 2635.81, 38.4), 1, 1.4, {
    ...
    exports["FIXDEV-polyzone"]:AddBoxZone("harmony_repairs_craft", vector3(1176.23, 2635.29, 37.75), 3, 2, {
    ...
    -- Hayes Autos | Start --
    exports["FIXDEV-polyzone"]:AddBoxZone("hayes_autos_stash", vector3(-1418.49, -454.77, 35.91), 1, 3.0, {
    ...
    exports["FIXDEV-polyzone"]:AddBoxZone("hayes_autos_craft", vector3(-1408.17, -447.34, 35.91), 1, 5.0, {
    ...
    -- Ottos Autos | Start --
    exports["FIXDEV-polyzone"]:AddBoxZone("ottos_autos_stash", vector3(837.15, -814.76, 26.33), 2, 3.0, {
    ...
    exports["FIXDEV-polyzone"]:AddBoxZone("ottos_autos_craft", vector3(840.33, -827.5, 26.33), 2, 3.6, {
    ...
    -- Tuner Shop | Start --
    exports["FIXDEV-polyzone"]:AddBoxZone("auto_exotics_stash", vector3(547.22, -182.99, 54.49), 5.0, 1, {
    ...
    exports["FIXDEV-polyzone"]:AddBoxZone("auto_exotics_craft", vector3(546.55, -166.74, 54.49), 5.0, 1, {
...
AddEventHandler('FIXDEV-polyzone:enter', function(name)
    if name == "auto_exotics_craft" then
        ...
        AutoExoticCraft()
        local isEmployed = exports["FIXDEV-business"]:IsEmployedAt("auto_exotics")
        if isEmployed then
            exports['FIXDEV-ui']:showInteraction("[E] Craft")
        end
