...
local function returnBoat()
    ...
    local finished = exports["FIXDEV-taskbar"]:taskBar(1000, "Returning Boat")
    ...
    TriggerEvent("FIXDEV-fishing:currentlyRentedBoat", currentlyRentedBoat)
end

function rentBoat()
    boatsValeted = boatsValeted + 1
    FreezeEntityPosition(PlayerPedId(), true)
    local finished = exports["FIXDEV-taskbar"]:taskBar(1000, "Valeting Boat")
...
AddEventHandler("FIXDEV-fishing:rentBoat", function(name)
...
AddEventHandler("FIXDEV-fishing:returnBoat", function()
