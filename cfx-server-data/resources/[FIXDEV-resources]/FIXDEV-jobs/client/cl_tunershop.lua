...
Citizen.CreateThread(function()
    exports["FIXDEV-polyzone"]:AddBoxZone("tuner_shop_docs_stash", vector3(128.46, -3014.08, 7.04), 2.5, 2.5, {
    ...
    exports["FIXDEV-polyzone"]:AddBoxZone("tuner_shop_docs_stash2", vector3(128.45, -3008.05, 7.04), 2, 3.2, {
...
RegisterNetEvent('FIXDEV-civjobs:craft-lockpick')
AddEventHandler('FIXDEV-civjobs:craft-lockpick', function()
    local job = exports["isPed"]:GroupRank('tuner')
    if job >= 1 and exports['FIXDEV-inventory']:hasEnoughOfItem('steel', 2) then
...
RegisterNetEvent('FIXDEV-civjobs:craft-advlockpick')
AddEventHandler('FIXDEV-civjobs:craft-advlockpick', function()
    local job = exports["isPed"]:GroupRank('tuner')
    if job >= 1 and exports['FIXDEV-inventory']:hasEnoughOfItem('refinedaluminium', 15) and exports['FIXDEV-inventory']:hasEnoughOfItem('refinedplastic', 12) and exports['FIXDEV-inventory']:hasEnoughOfItem('refinedrubber', 15) then
...
RegisterNetEvent('FIXDEV-civjobs:craft-repairkit')
AddEventHandler('FIXDEV-civjobs:craft-repairkit', function()
    local job = exports["isPed"]:GroupRank('tuner')
    if job >= 1 and exports['FIXDEV-inventory']:hasEnoughOfItem('electronics', 25) then
...
RegisterNetEvent('FIXDEV-civjobs:tuner_craft')
AddEventHandler('FIXDEV-civjobs:tuner_craft', function()
    TriggerEvent('FIXDEV-context:sendMenu', {
        ...
        },
        {
            ...
            params = {
                event = "FIXDEV-civjobs:craft-lockpick"
            }
        },
        {
            id = 3,
            ...
            params = {
                event = "FIXDEV-civjobs:craft-advlockpick"
            }
        },
        {
            id = 4,
            ...
            params = {
                event = "FIXDEV-civjobs:craft-repairkit"
            }
        },
        {
            id = 5,
...
Citizen.CreateThread(function()
    exports["FIXDEV-polyzone"]:AddBoxZone("tuner_shop_docs_craft", vector3(144.39, -3050.88, 7.04), 4, 1.4, {
	...
	Citizen.CreateThread(function()
        while DreamsCraftDocs do
			...
			if IsControlJustReleased(0, 38) then
                    local rank = exports["isPed"]:GroupRank("tuner")
                    if rank > 0 then 
                    TriggerEvent('FIXDEV-civjobs:tuner_craft')
                end
			end
		end
	end)
