...
--[[function isDisabled()
    return exports["FIXDEV-base"]:getVar("dead") or
        exports["FIXDEV-base"]:getVar("handcuffed")
end]]

function hasPhone()
    return exports["FIXDEV-inventory"]:hasEnoughOfItem("mobilephone", 1, false) or
...
function hasRepairItems(type)
    ...
    for i, v in pairs(items) do
        if exports["FIXDEV-inventory"]:hasEnoughOfItem(v, 1, false) then
            return true
        end
    end
