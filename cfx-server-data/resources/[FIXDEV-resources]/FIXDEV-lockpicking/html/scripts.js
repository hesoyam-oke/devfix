...
function outOfPins() {
  $.post('http://FIXDEV-lockpicking/failure', JSON.stringify({}));
  gameOver = true;
...
function unlock() {
  $.post('http://FIXDEV-lockpicking/complete', JSON.stringify({}));
...
document.onkeyup = function (data) {
  if (data.which == 27 ) {
    $.post('http://FIXDEV-lockpicking/close', JSON.stringify({}));
  }
};
