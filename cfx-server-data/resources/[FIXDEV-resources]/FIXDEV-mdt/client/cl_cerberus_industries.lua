Citizen.CreateThread(function()
  exports["FIXDEV-polytarget"]:AddBoxZone("cerb_indsutries_craft", vector3(221.0, -986.58, -99.0), 1.6, 1, {
    heading=0,
    minZ=-99.4,
    maxZ=-98.6,
  })
  exports["FIXDEV-polytarget"]:AddBoxZone("cerb_indsutries_craft_cia", vector3(1612.29, 2656.53, -158.27), 1, 1, {
    heading=270,
    minZ=-158.27,
    maxZ=-157.47,
  })
  exports["FIXDEV-polytarget"]:AddBoxZone("cerb_indsutries_craft_arena", vector3(5520.87, 5985.68, 590.0), 1, 1, {
    heading=0,
    minZ=589.8,
    maxZ=590.6,
  })
  exports["FIXDEV-polyzone"]:AddBoxZone("cerb_armory_elevator_shaft", vector3(1630.6083984, 2659.0908203, -70.3896408), 8.2, 15.2, {
    heading=0,
    minZ=-164.4,
    maxZ=20.8,
  })

  exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("cerb_indsutries_craft", {{
    id = 'ci_craft_wingsuits',
    label = 'Wingsuits',
    icon = 'circle',
    event = "FIXDEV-cerb-industries:craftStuff",
    parameters =  { id = "420ci_wingsuits" },
  }}, { distance = { radius = 1.5 } })

  exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("cerb_indsutries_craft_cia", {{
    id = 'cia_craft',
  ...
  exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("cerb_indsutries_craft_arena", {{
    id = 'ci_craft_misc',
    label = 'Misc',
    icon = 'circle',
    event = "FIXDEV-cerb-industries:craftStuff",
...
AddEventHandler("FIXDEV-cerb-industries:craftStuff", function(p1, p2, p3)
...
RegisterNetEvent("FIXDEV-cbc:iplStatesUpdate", function(pStates)
  iplStates = pStates
  updateIpls()
end)

Citizen.CreateThread(function()
  TriggerServerEvent("FIXDEV-cbc:getIplsStates")
end)
...
AddEventHandler('FIXDEV-objects:objectDeleted', function(pObject, pHandle)
  if pObject.data.model ~= elevatorHash then return end
  elevatorEntity = nil
end)
...
-- local timePlaces = {}
-- RegisterNetEvent("FIXDEV-cia:elevator", function(pDir)
