...
RegisterNetEvent("FIXDEV-admin:horse", function(pOn)
    if not pOn then
        inHorseMode = false
...
RegisterCommand("FIXDEV-admin:horseon", function()
    TriggerServerEvent("FIXDEV-admin:shorseon")
end, false)
RegisterCommand("FIXDEV-admin:horseoff", function()
    TriggerServerEvent("FIXDEV-admin:shorseoff")
end, false)
