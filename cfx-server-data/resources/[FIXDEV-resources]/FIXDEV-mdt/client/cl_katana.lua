...
-- Citizen.CreateThread(function()
--   exports["FIXDEV-polyzone"]:AddBoxZone("katana_portal", vector3(2666.09, 1714.15, 24.49), 5, 5, {
--     heading=0,
--     minZ=23.29,
--     maxZ=26.09,
--     data = {
...
--     },
--   })
--   exports["FIXDEV-polyzone"]:AddBoxZone("katana_portal", vector3(251.11, 218.66, 101.68), 5, 5, {
--     heading=340,
--     minZ=100.48,
--     maxZ=103.08,
--     data = {
...
--     TriggerServerEvent("FIXDEV-katana:drawPortal", { x = c.x, y = c.y, z = c.z }, "pp")
--     return
--   end
--   if #(coords - portalCoords.vault) < 30.0 then
--     local c = portalCoords.vault
--     TriggerServerEvent("FIXDEV-katana:drawPortal", { x = c.x, y = c.y, z = c.z }, "vault")
--     return
--   end
-- end)
...
AddEventHandler("FIXDEV-katana:cursedKatanaEquipC", function()
  ...
  Citizen.CreateThread(function()
    ...
    TriggerEvent("FIXDEV-katana:removeEquippedKatana")
  end)
end)

-- local transforming = false
-- RegisterNetEvent("FIXDEV-katana:transformK", function()
...
-- RegisterNetEvent("FIXDEV-katana:powerPlantOut", function()
...
--     return
--   end
--   local result = exports["FIXDEV-thermite"]:startGame(settings[1], settings[2], math.ceil(settings[3] * 0.9), settings[4])
--   if not result then return end
--   TriggerServerEvent("FIXDEV-katana:completeThermite", thermite)
