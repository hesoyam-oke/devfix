...
AddEventHandler("FIXDEV-placeables:pickup", function(p1, p2, p3)
...
AddEventHandler("FIXDEV-placeables:inspect", function(p1, p2, p3)
  local item = p3.meta.data.metadata.item
  local info = exports["FIXDEV-inventory"]:itemListInfo(item)
  info = json.decode(info)
...
Citizen.CreateThread(function()
  ...
  exports["FIXDEV-interact"]:AddPeekEntryByModel(models, {
    {
      id = "pickupplaceable",
      event = "FIXDEV-placeables:pickup",
      icon = "circle",
      label = "Grab",
    },
  }, {
  ...
  exports["FIXDEV-interact"]:AddPeekEntryByModel(models, {
    {
      id = "inspectplaceable",
      event = "FIXDEV-placeables:inspect",
      icon = "circle",
      label = "Inspect",
    },
  }, {
...
-- Citizen.CreateThread(function()
--   exports["FIXDEV-polytarget"]:AddBoxZone("bronco_clue_book", vector3(1011.18, -2887.96, 39.16), 1, 1, {
--     heading=0,
--     minZ=38.76,
--     maxZ=39.56,
--   })
--   exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("bronco_clue_book", {{
...
--     distance = { radius = 1.5 },
--   })
--   exports["FIXDEV-polytarget"]:AddBoxZone("rage_clue_book", vector3(128.28, 272.95, 109.97), 1, 1, {
--     heading=342,
--     minZ=109.57,
--     maxZ=110.37,
--   })
--   exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("rage_clue_book", {{
...
--     distance = { radius = 1.5 },
--   })
--   exports["FIXDEV-polytarget"]:AddBoxZone("hope_clue_book", vector3(-693.41, 73.74, 55.86), 1, 1, {
--     heading=27,
--     minZ=55.46,
--     maxZ=56.26,
--   })
--   exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("hope_clue_book", {{
