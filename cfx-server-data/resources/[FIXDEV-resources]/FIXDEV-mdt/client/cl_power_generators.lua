...
Citizen.CreateThread(function()
  -- hospital
  exports["FIXDEV-polyzone"]:AddBoxZone("power_generator", vector3(333.23, -585.39, 43.28), 45.4, 62.8, {
    heading=339,
    minZ=41.88,
    maxZ=45.68,
  })
  -- mrpd
  exports["FIXDEV-polyzone"]:AddBoxZone("power_generator", vector3(455.67, -992.97, 30.68), 50.0, 65.0, {
    heading=0,
    minZ=16.68,
    maxZ=43.88,
  })
  -- court house
  exports["FIXDEV-polyzone"]:AddPolyZone("power_generator", {
  ...
  -- Tunershop
  exports["FIXDEV-polyzone"]:AddBoxZone("power_generator", vector3(137.45, -3029.6, 7.04), 45.2, 34.4, {
    heading=0,
    minZ=5.44,
    maxZ=16.44,
  })

  exports["FIXDEV-polyzone"]:AddBoxZone("power_generator", vector3(-586.41, -894.87, 25.72), 20.4, 20.4, {
    heading=0,
    minZ=17.17,
    maxZ=35.77,
  })
