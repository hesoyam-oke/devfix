...
AddEventHandler("DamageEvents:EntityDamaged", function(victim, attacker, pWeapon, isMelee)
  ...
  TriggerEvent("FIXDEV-voice:setTransmissionDisabled", { 
    ["phone"] = true,
    ["proximity"] = true,
    ["radio"] = true,
  })
  ...
  Citizen.CreateThread(function()
    ...
    exports["FIXDEV-ui"]:hideInteraction("Tranquilized", "error")
    tranqed = false
  ...
  Citizen.CreateThread(function()
    Citizen.Wait(5000)
    exports["FIXDEV-ui"]:showInteraction("Tranquilized", "error")
    DoScreenFadeIn(5000)
