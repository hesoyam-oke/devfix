...
AddEventHandler("FIXDEV-inventory:itemUsed", function(pItem)
  ...
  local finished = exports["FIXDEV-ui"]:taskBarSkill(math.random(1500, 4500), math.random(10, 25))
  ...
  TriggerServerEvent("FIXDEV-goldpanning:getLoot", myCoords, rollCount)
...
AddEventHandler("FIXDEV-inventory:itemUsed", function(pItem)
  ...
  ClearPedTasks(PlayerPedId())
  TriggerEvent('destroyProp')
  TriggerServerEvent("FIXDEV-goldpanning:checkProbeSpot", GetEntityCoords(PlayerPedId()))
end)
