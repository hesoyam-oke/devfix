...
ImplantItem['microchipimplant'] = async (pItemId, pItemInfo) => {
    ...
    NPX.Procedures.execute('FIXDEV-miscscripts:implant:installed', pItemInfo);

    await new Promise((resolve) => setTimeout(resolve, 1000))

    exports['FIXDEV-fx'].PlayEntitySound(PlayerPedId(), "Beep_Green", "DLC_HEIST_HACKING_SNAKE_SOUNDS", 1);
