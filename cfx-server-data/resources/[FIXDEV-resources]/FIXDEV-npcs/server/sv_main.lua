RegisterServerEvent("FIXDEV-npcs:location:fetch")
AddEventHandler("FIXDEV-npcs:location:fetch",function()
    local src = source
    ...
    TriggerClientEvent("FIXDEV-npcs:set:ped", src, Generic.NPCS)
end)