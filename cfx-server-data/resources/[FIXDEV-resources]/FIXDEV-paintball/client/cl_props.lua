...
AddEventHandler("FIXDEV-props:attachProp", function(attachModelSent, boneNumberSent, x, y, z, xR, yR, zR, keepOtherProps, altVertex, name)
  attachProp(attachModelSent, boneNumberSent, x, y, z, xR, yR, zR, keepOtherProps, altVertex, name)
end)
AddEventHandler("FIXDEV-props:removeProp", function()
  removeAttachedProp()
end)
AddEventHandler("FIXDEV-props:removePropByName", function(pName)
