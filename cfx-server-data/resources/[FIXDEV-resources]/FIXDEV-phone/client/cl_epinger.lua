...
RegisterNUICallback("FIXDEV-ui:pingSend", function(data, cb)
...
RegisterNUICallback("FIXDEV-ui:pingAccept", function(data, cb)
...
RegisterNUICallback("FIXDEV-ui:pingReject", function(data, cb)
