...
RegisterNUICallback('wenmoSubmit', function(data)
    ...
    TriggerServerEvent('FIXDEV-phone:transferWenmo',num,amount,comment)
end)

RegisterNUICallback("FIXDEV-phone:getWenmo", function(data, cb)
    local success, message = RPC.execute("FIXDEV-phone:getWenmo")
    local wenmo = {}
