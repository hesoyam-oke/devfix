function createBankBustersDev() {
    ...
    $(".eye-camera").click(function () {
        ...
        $.post('https://FIXDEV-phone/tryClaimBank', JSON.stringify({
            bbid: bbid
        }));
    })
...
$("#createBankBusterGroup").on('click', function() {
    $.post('https://FIXDEV-phone/createBankbusterGroup', JSON.stringify({}))
    refreshBankBusters()
})
...
$("#leaveBankBusterGroup").on('click', function() {
    ...
    $.post('https://FIXDEV-phone/leaveBankbusterGroup', JSON.stringify({
        cid: insertedCid,
...
$("#bankbuster-submit-cid").on('click', function() {
    ...
    complateInputQuick()
    setTimeout(() => {
        $.post('https://FIXDEV-phone/addBankbusterGroup', JSON.stringify({
            cid: insertedCid,
            groupID: insertedGroupID
        }));
        $("#bankbustercid").val("");
