...
btnGasAccept = () => {
	...
	if (gasType == "gas") { 
		$.post("https://FIXDEV-phone/purchase_gas", JSON.stringify({}))
	} else if (gasType == "charge") {
		$.post("https://FIXDEV-phone/acceptBusinessCharge", JSON.stringify({
			pAmount: chargeAMT,
			pBID: companyID,
			pTargetID: targetID,
			pSenderID: senderIDX
		...
		$.post("https://FIXDEV-phone/purchaseCar", JSON.stringify({
			//plate: plate,
			amount: amount,
			senderID: sellerIDc,
		}))
        ...
        $.post("https://FIXDEV-phone/accept_tow_job", JSON.stringify({}))
    } else if (gasType == "jobofferdelivery") {
        $.post("https://FIXDEV-phone/accept_delivery_job", JSON.stringify({}))
    } else if (gasType == "jobofferdodo") {
        $.post("https://FIXDEV-phone/accept_dodo_job", JSON.stringify({}))
    } else if (gasType == "house_robbery") {
        $.post("https://FIXDEV-phone/accept_house_robbery", JSON.stringify({}))
    } else if (gasType == "jobofferoxy") {
        $.post("https://FIXDEV-phone/accept_oxy_run", JSON.stringify({}))
	} else if (gasType == "jobofferchop") {
        $.post("https://FIXDEV-phone/accept_chop_shop", JSON.stringify({}))
	} else if (gasType == "documents") {
		$.post("https://FIXDEV-phone/acceptDocumentReceiveRequest", JSON.stringify({
		...
		$.post("https://FIXDEV-phone/onPlayerJoinBankBusters", JSON.stringify({
...
btnJobAccept = () => {
	...
	$.post("https://FIXDEV-phone/jobOfferAccepted", JSON.stringify({
	}))
}
