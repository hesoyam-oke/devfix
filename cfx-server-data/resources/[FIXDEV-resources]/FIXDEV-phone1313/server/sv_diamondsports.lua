RPC.register("FIXDEV-phone:submitNewEventDiamondSports", function(pSource, pEventName, pEventLocation, pTimeZone, pEventTimeHr, pEventTimeMin, pEventDate)
...
RPC.register("FIXDEV-phone:getDiamondSportsEvents", function(pSource)
...
RPC.register("FIXDEV-phone:deleteDiamondEvent", function(pSource, pID)
