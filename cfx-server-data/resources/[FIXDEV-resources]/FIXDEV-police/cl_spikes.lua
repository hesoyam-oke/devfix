...
-- Citizen.CreateThread(function()
--     exports["FIXDEV-polyzone"]:AddBoxZone("evidence_sandypd", vector3(1850.07, 3694.39, 34.28), 3, 3, {
...
Citizen.CreateThread(function()
    exports["FIXDEV-polyzone"]:AddBoxZone("bennys_sandypd", vector3(1878.17, 3695.39, 33.49), 4, 6.8, {
        name="bennys_sandypd",
        heading=30,
        --debugPoly=true,
        minZ=32.09,
...
RegisterNetEvent('FIXDEV-police:AttemptBennys:SandyPD')
AddEventHandler('FIXDEV-police:AttemptBennys:SandyPD', function()
    local car = GetVehiclePedIsIn(PlayerPedId(), false)
    local myJob = exports["isPed"]:isPed("myJob")
    if myJob == 'police' or myJob == 'state' or myJob == 'sheriff' or myJob == 'ranger' then

    if car ~= 0 then
        TriggerEvent('FIXDEV-bennys:enter_location', 16) -- Dev bennys
        else
