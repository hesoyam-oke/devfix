...
Citizen.CreateThread(function()
  exports["FIXDEV-keybinds"]:registerKeyMapping("", "Player", "Drop Prop", "+propAttachDrop", "-propAttachDrop")
...
RegisterNetEvent('FIXDEV-propattach:attach')
AddEventHandler('FIXDEV-propattach:attach', function(pPropItem, pTargetFunction)
