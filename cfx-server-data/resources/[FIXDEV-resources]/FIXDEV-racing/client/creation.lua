...
function startRaceCreation(options)
    ...
    while raceName ~= nil and options.raceName == nil and RPC.execute("FIXDEV-racing:isRaceNameTaken", raceName) == true do
...
function finishRaceCreation()
    ...
    TriggerServerEvent("FIXDEV-racing:recieveCreateData", raceName, raceType, raceThumbnail, checkpoints)
...
RegisterNetEvent("FIXDEV-racing:cmd:racecreate")
AddEventHandler("FIXDEV-racing:cmd:racecreate", function(options)
    if GetVehiclePedIsIn(PlayerPedId(), false) ~= 0 then
        startRaceCreation(options)
    end
end)

RegisterNetEvent("FIXDEV-racing:cmd:racecreatedone")
AddEventHandler("FIXDEV-racing:cmd:racecreatedone", function()
    finishRaceCreation()
end)

RegisterNetEvent("FIXDEV-racing:cmd:racecreatecancel")
AddEventHandler("FIXDEV-racing:cmd:racecreatecancel", function()
    cancelRaceCreation()
end)
