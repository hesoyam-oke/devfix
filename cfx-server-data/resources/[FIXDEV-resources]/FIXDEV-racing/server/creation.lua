RegisterNetEvent("FIXDEV-racing:recieveCreateData")
AddEventHandler("FIXDEV-racing:recieveCreateData", function(pRaceName, pRaceType, pRaceThumbnail, pCheckpoints)
    local src = source
    ...
    TriggerClientEvent("FIXDEV-racing:addedRace", -1, {}, Races)
    TriggerClientEvent("DoLongHudText", src, "Race " .. pRaceName .. " created!")
end)

RPC.register("FIXDEV-racing:isRaceNameTaken", function(src, pRaceName)
