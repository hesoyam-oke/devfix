...
RPC.register("FIXDEV-racing:getAllRaces", function(pSrc)
    local src = pSrc
...
RegisterNetEvent('FIXDEV-racing:allRaces')
AddEventHandler('FIXDEV-racing:allRaces', function()
    local allRaces = {
        races = Races,
        pendingRaces = PendingRaces,
        activeRaces = ActiveRaces,
    ...
    TriggerEvent('FIXDEV-phone:allRaces', allRaces) 
end)
...
RPC.register("FIXDEV-racing:awardPlayer", function(pSrc, pAmt)
...
Citizen.CreateThread(function()
    ...
    Wait(100)
    TriggerEvent('FIXDEV-racing:allRaces')
end)

RPC.register('FIXDEV-racing:setAlias', function(src, usedItemIds, usedItemSlots, aliass)
    print("i am here")
...
RPC.register('FIXDEV-racing:giveRacingUSB', function(pSource)
