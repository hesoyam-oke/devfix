...
Citizen.CreateThread(function()
  SERVER_CODE = exports["FIXDEV-config"]:GetServerCode()
  -- manage food menus
  for _, zone in ipairs(MENU_ZONES) do
    exports["FIXDEV-polytarget"]:AddBoxZone("restaurant_manage_food_menu", table.unpack(zone))
  end

  exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("restaurant_manage_food_menu",  {{
    event = "FIXDEV-restaurants:manageFoodMenu",
    id = "restaurantfoodmenu",
    icon = "circle",
    label = "Manage Food",
  },
  {
    event = "FIXDEV-restaurants:manageDailyMenu",
  ...
  for _, zone in ipairs(BUFF_ZONES) do
    exports['FIXDEV-polyzone']:AddCircleZone("restaurant_buff_zone", table.unpack(zone))
  end

  for _, zone in ipairs(SHELF_ZONES) do
    exports['FIXDEV-polytarget']:AddBoxZone("restaurant_shelf", table.unpack(zone))
  end

  exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('restaurant_shelf', {{
    event = "FIXDEV-restaurants:shelfPrompt",
  ...
  exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("restaurant_shelf", {{
    event = "FIXDEV-restaurants:silentAlarm",
  ...
  for _, zone in ipairs(REGISTER_ZONES) do
    exports["FIXDEV-polytarget"]:AddBoxZone("restaurant_registers", table.unpack(zone))
  end

  -- Drive Thru window register
  exports["FIXDEV-polyzone"]:AddBoxZone("restaurant_registers", vector3(-1193.81, -907.8, 13.98), 4.0, 2.4, {
    heading=355,
    minZ=12.98,
    maxZ=15.38,
    data = {
  ...
  exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('restaurant_registers', {{
    event = "FIXDEV-restaurants:makePayment",
  ...
  exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('restaurant_registers', {{
    event = "FIXDEV-restaurants:chargeCustomer",
  ...
  for _, zone in ipairs(SIGN_ON_ZONES) do
    exports["FIXDEV-polytarget"]:AddBoxZone("restaurant_sign_on", table.unpack(zone))
  end

  exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('restaurant_sign_on', {{
      event = "FIXDEV-restaurants:signOnPrompt",
  ...
  exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('restaurant_sign_on', {{
      event = "FIXDEV-restaurants:signOffPrompt",
  ...
  exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('restaurant_sign_on', {{
      event = "FIXDEV-restaurants:viewActiveEmployees",
      id = "restaurants_active_employees",
      icon = "list",
      label = _L("restaurant-view-employee-list", "View Active Employees"),
  }}, { distance = { radius = 3.5 }, isEnabled = function(pEntity, pContext) return pContext.zones['restaurant_sign_on'] and exports['FIXDEV-business']:IsEmployedAt(pContext.zones['restaurant_sign_on'].biz) end })

  exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('restaurant_sign_on', {{
    event = "FIXDEV-restaurants:setWorkHours",
    ...
    label = _L("restaurant-set-work-hours", "Set Work Hours"),
      ...
      return pContext.zones['restaurant_sign_on'] and exports['FIXDEV-business']:HasPermission(pContext.zones['restaurant_sign_on'].biz, 'hire')
    end
  })

  exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('restaurant_sign_on', {{
    event = "FIXDEV-restaurants:viewWorkHours",
    id = "restaurants_view_work_hours",
    icon = "user-clock",
    label = _L("restaurant-view-work-hours", "View Work Hours"),
  }}, { distance = { radius = 3.5 }, isEnabled = function(pEntity, pContext)
      return pContext.zones['restaurant_sign_on'] and exports['FIXDEV-business']:IsEmployedAt(pContext.zones['restaurant_sign_on'].biz)
    end
  })

  exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('restaurant_sign_on', {{
    event = "FIXDEV-restaurants:getHeadset",
    id = "restaurants_get_headset",
    icon = "headset",
    label = _L("restaurant-get-headset", "Get Headset"),
  }}, { distance = { radius = 3.5 }, isEnabled = function(pEntity, pContext)
      return pContext.zones['restaurant_sign_on'] and pContext.zones['restaurant_sign_on'].biz == 'burger_shot' and exports['FIXDEV-business']:IsEmployedAt(pContext.zones['restaurant_sign_on'].biz)
    end
  })

  -- main dishes
  for _, zone in ipairs(CREATE_ZONES) do
    exports["FIXDEV-polytarget"]:AddBoxZone("restaurant_create_food_item", table.unpack(zone))
  end

  exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("restaurant_create_food_item",  {{
    event = "FIXDEV-restaurants:createFoodItem",
  ...
  for _,zone in ipairs(FRIDGE_ZONES) do
    exports["FIXDEV-polytarget"]:AddBoxZone("restaurant_fridge", table.unpack(zone))
  end

  exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('restaurant_fridge', {{
    event = "FIXDEV-restaurants:openFridge",
    id = "restaurantfridge",
    icon = "box",
    label = _L("restaurant-open", "Open")
  }}, { distance = { radius = 3.5 }, isEnabled = isSignedOn })
  ...
  for _,zone in ipairs(TAKEOUT_ZONES) do
    exports["FIXDEV-polytarget"]:AddBoxZone("restaurant_takeout", table.unpack(zone))
  end

  exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("restaurant_takeout",  {{
    event = "FIXDEV-restaurants:getTakeoutItem",
  ...
  exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget("restaurant_takeout",  {{
    event = "FIXDEV-restaurants:getToyItem",
  ...
  exports["FIXDEV-interact"]:AddPeekEntryByModel({ `p_v_43_safe_s` }, {
    {
      id = "restaurant_safe_view",
      event = "FIXDEV-restaurants:viewSafeCash",
      icon = "wallet",
      label = "Check Cash Amount",
    },
    {
      id = "restaurant_safe_take",
      event = "FIXDEV-restaurants:takeSafeCash",
      icon = "money-bill",
      label = "Take Cash Envelope",
    },
  }, { distance = { radius = 5.0 }, isEnabled = function(pEntity, pContext)
    return pContext.meta and pContext.meta.data and pContext.meta.data.metadata.isBusinessSafe and exports['FIXDEV-business']:HasPermission(pContext.meta.data.metadata.business, 'craft_access')
  end})

  exports["FIXDEV-interact"]:AddPeekEntryByModel({ `p_v_43_safe_s` }, {
    {
      id = "restaurant_safe_crack",
      event = "FIXDEV-restaurants:crackSafe",
      icon = "unlock",
      label = "crack safe",
    },
  }, { distance = { radius = 5.0 }, isEnabled = function(pEntity, pContext)
    return pContext.meta and pContext.meta.data and pContext.meta.data.metadata.isBusinessSafe and exports["FIXDEV-inventory"]:hasEnoughOfItem("safecrackingkit", 1, false, true)
  end})

  exports['FIXDEV-polyzone']:AddBoxZone("restaurant_bs_drivethru", vector3(-1207.32, -898.81, 13.04), 8.0, 6.4, {
    heading = 35,
    minZ = 12.04,
    maxZ = 15.44,
    data = {
