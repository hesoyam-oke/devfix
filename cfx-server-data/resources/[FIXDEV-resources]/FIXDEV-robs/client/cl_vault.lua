...
AddEventHandler('ghost:HackDoorVault2', function()
            ...
            Citizen.Wait(7000)
            exports["FIXDEV-heists"]:StartHacking({
            action = "open",
            time = 5,
            amount = 6,
            correct = 9,
...
function VaultPDNoti()
    ...
    TriggerEvent('FIXDEV-dispatch:DispatchVaultAlert')
...
AddEventHandler('vault:Reset', function()
  TriggerServerEvent("FIXDEV-doors:change-lock-state", 49, true)
  TriggerServerEvent('FIXDEV-doors:change-lock-state', 48, true)
  TriggerServerEvent('FIXDEV-doors:change-lock-state', 46, true)
  TriggerServerEvent('FIXDEV-doors:change-lock-state', 50, true) 
  allowedToGrab = false
end)
