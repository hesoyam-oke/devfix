...
RegisterNUICallback('callback', function(data, cb)
    ...
    if location == "fleeca"then
        if data.success == true then 
            TriggerEvent('FIXDEV-fleeca:addPlease')
        elseif data.success == false then
            TriggerEvent('FIXDEV-fleeca:removePlease')
        end
