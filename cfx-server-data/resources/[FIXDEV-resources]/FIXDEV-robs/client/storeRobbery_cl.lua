...
RegisterNetEvent("FIXDEV-robberies:HitSafes")
AddEventHandler("FIXDEV-robberies:HitSafes", function()
	local storeid = isStoreRobbery()
	if storeid ~= 0 then
...
RegisterNetEvent("FIXDEV-robberies:HitRegister")
AddEventHandler("FIXDEV-robberies:HitRegister", function()
