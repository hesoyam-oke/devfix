...
RegisterNetEvent("FIXDEV-scenes:allScenes")
AddEventHandler("FIXDEV-scenes:allScenes", function(scenes)
  activeScenes = scenes
end)

RegisterNetEvent("FIXDEV-scenes:refreshScenes")
AddEventHandler("FIXDEV-scenes:refreshScenes", function(sceneId, scene)
...
RegisterNetEvent("FIXDEV-scenes:deleteScene")
AddEventHandler("FIXDEV-scenes:deleteScene", function(removeId)
  if removeId then
...
function calculateScenesToDraw()
  ...
  local isPeekActive = exports['FIXDEV-interact']:IsPeeking()
...
RegisterInterfaceCallback("FIXDEV-ui:scenes:input", function(data, cb)
...
RegisterCommand("+startScene", function()
  if sceneStarted then
    ...
    exports['FIXDEV-interface']:openApplication('textbox', {
      callbackUrl = 'FIXDEV-ui:scenes:input',
      key = 1,
      items = {
        {
          icon = "pencil-alt",
...
RegisterCommand("+deleteScene", function()
  ...
  TriggerServerEvent("FIXDEV-scenes:deleteScene", GetEntityCoords(PlayerPedId()))
end, false)
RegisterCommand("-deleteScene", function() end, false)

Citizen.CreateThread(function()
  exports["FIXDEV-keybinds"]:registerKeyMapping("", "Scenes", "Start / Place Scene", "+startScene", "-startScene")
  exports["FIXDEV-keybinds"]:registerKeyMapping("", "Scenes", "Enable / Disable", "+enableScene", "-enableScene")
  exports["FIXDEV-keybinds"]:registerKeyMapping("", "Scenes", "Delete Closest Scene", "+deleteScene", "-deleteScene")
  RequestStreamedTextureDict('commonmenu', true)
  Wait(5000)
  TriggerServerEvent("FIXDEV-scenes:getScenes")
end)