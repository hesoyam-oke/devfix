...
RegisterNetEvent("FIXDEV-scoreboard:RemovePlayer")
AddEventHandler("FIXDEV-scoreboard:RemovePlayer", function(data)
    NPX.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("FIXDEV-scoreboard:AddPlayer")
AddEventHandler("FIXDEV-scoreboard:AddPlayer", function(data)
    NPX.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("FIXDEV-scoreboard:RemoveRecent")
AddEventHandler("FIXDEV-scoreboard:RemoveRecent", function(src)
    NPX.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("FIXDEV-scoreboard:AddAllPlayers")
AddEventHandler("FIXDEV-scoreboard:AddAllPlayers", function(data)
