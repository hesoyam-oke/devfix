...
RegisterServerEvent('FIXDEV-scoreboard:AddPlayer')
AddEventHandler("FIXDEV-scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("FIXDEV-scoreboard:AddPlayer", -1, data )
...
function NPX.Scoreboard.AddAllPlayers(self)
    ...
    for i, _PlayerId in pairs(GetPlayers()) do
        ...
        TriggerClientEvent("FIXDEV-scoreboard:AddAllPlayers", source, data)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("FIXDEV-scoreboard:RemovePlayer", -1, data )
    Wait(600000)
    TriggerClientEvent("FIXDEV-scoreboard:RemoveRecent", -1, plyid)
end)
