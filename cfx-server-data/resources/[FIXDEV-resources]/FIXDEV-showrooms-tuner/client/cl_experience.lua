...
RegisterNUICallback("FIXDEV-ui:tunerapplication-closed", function(data, cb)
...
RegisterNUICallback("FIXDEV-ui:tunershowroomChangeCar", function(data, cb)
  if vehicle then
    DeleteEntity(vehicle)
  end
...
AddEventHandler("FIXDEV-showrooms-tuner:enterExperience", function()
  openShowroom("pdm")
