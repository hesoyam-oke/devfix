...
RegisterNUICallback("FIXDEV-ui:application-closed", function(data, cb)
...
RegisterNUICallback("FIXDEV-ui:showroomChangeCar", function(data, cb)
  if vehicle then
    DeleteEntity(vehicle)
  end
...
AddEventHandler("FIXDEV-showrooms:enterExperience", function()
  openShowroom("pdm")
