...
var ShowroomFunctions = {
    ...
    TUNER_Load: function() {
        ...
        $(".start-container").show();
        $(".lds-spinner").show();
        ShowroomFunctions.TUNER_getChars()
        setTimeout(function() {
            $(".showcase").show();
            $(".main").show()
            setTimeout(function() {
    ...
    getChars: function() {
        $.post('https://FIXDEV-showrooms/FIXDEV-ui:showroomChangeCar', JSON.stringify({ model: cars[selectedId].model }), function(cb) {
...
$(document).ready(function() {
    ...
    window.addEventListener('message', (event) => {
        ...
        if (data.meta.message = "done") {
            ...
            $.post('https://FIXDEV-showrooms/FIXDEV-ui:application-closed', JSON.stringify({ name: "showroom" }));
        }
    })
});
...
$(document).on("click", "#purchase", function() {
    canPress = false
    $.post('https://FIXDEV-showrooms/showroomPurchaseCurrentVehicle', JSON.stringify({ model: cars[selectedId].model, price: cars[selectedId].price, zoneName: zone }), function(cb) {
        if (cb.meta.ok) {
            ShowroomFunctions.Close()
            canPress = false
        } else {
