...
RegisterServerEvent("FIXDEV-signin:duty")
AddEventHandler("FIXDEV-signin:duty", function(pJobType, pSrc)
...
RegisterServerEvent("FIXDEV-signoff:duty")
AddEventHandler("FIXDEV-signoff:duty", function(job)
	local src = source
    if job == 'police' then
