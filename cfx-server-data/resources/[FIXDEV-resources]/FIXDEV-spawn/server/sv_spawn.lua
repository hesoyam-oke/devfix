...
RegisterServerEvent("FIXDEV-login:disconnectPlayer")
AddEventHandler("FIXDEV-login:disconnectPlayer", function()
    local src = source
    DropPlayer(src, "You DisConnected")
end)

RegisterServerEvent("FIXDEV-base:playerSessionStarted")
