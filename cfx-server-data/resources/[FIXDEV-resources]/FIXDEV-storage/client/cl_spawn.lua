...
AddEventHandler("FIXDEV-inventory:itemUsed", function (itemId, itemInfo)
...
function spawn(coordinates)
    local location = exports["FIXDEV-housing"]:getCurrentLocation()
    if location then
    ...
    TriggerServerEvent("FIXDEV-storage:prepareStorage", isSelecting, cid, coordinates, heading)
