TriggerServerEvent("FIXDEV:sync:player:ready")
...
function syncNative(name, netEntity, options, ...)
    TriggerServerEvent("FIXDEV-sync:executeSyncNative", name, netEntity, options, table.pack(...))
end
exports("syncNative", syncNative)

RegisterNetEvent("FIXDEV-sync:clientExecuteSyncNative")
AddEventHandler("FIXDEV-sync:clientExecuteSyncNative", function(native, netEntity, options, args)
