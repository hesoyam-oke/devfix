...
function openGui(sentLength,taskID,namesent,keepWeapon)
    ...
    guiEnabled = true
    pTaskActive = 1
    exports["FIXDEV-interface"]:sendAppEvent("taskbar", {
        display = true,
        duration = sentLength,
        taskID = taskID,
        label = namesent,
...
function handheld() 
  ...
  function generalInventory()
    if not insidePrompt and not inventoryDisabled and not forceInventoryDisabled and not exports['FIXDEV-taskbar']:pInInv() then
...
Citizen.CreateThread(function()
    exports["FIXDEV-keybinds"]:registerKeyMapping("", "Radio", "Open", "+handheld", "-handheld", "I")
