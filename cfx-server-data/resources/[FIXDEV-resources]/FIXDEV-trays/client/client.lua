...
Citizen.CreateThread(function()
    for pID, pData in pairs(traysList) do
        exports["FIXDEV-polytarget"]:AddBoxZone(pData.id .. pID, pData.coords, pData.length, pData.width, {
        ...
        exports['FIXDEV-interact']:AddPeekEntryByPolyTarget(pData.id .. pID, {{
            event = "FIXDEV-trays:client:pickupPrompt",
            id = pData.id .. pID,
            icon = "hand-holding",
            label = "Open",
            parameters = {
...
AddEventHandler('FIXDEV-trays:client:pickupPrompt', function(pParameters, pEntity, pContext)
    serverCode = "wl"
