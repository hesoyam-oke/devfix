...
RegisterNetEvent("FIXDEV-ui:open-application")
AddEventHandler("FIXDEV-ui:open-application", openApplication)
...
function closeApplication(app, data)
  ...
  TriggerEvent("FIXDEV-ui:application-closed", app, { fromEscape = false })
end
...
RegisterNetEvent("FIXDEV-ui:soundPlay")
AddEventHandler("FIXDEV-ui:soundPlay", function(name, volume, loop)
