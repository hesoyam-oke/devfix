...
function ConnectToATCFrequency()
    local subscribers = RPC.execute('FIXDEV-voice:atc:subscribe')
...
function DisconnectFromATCFrequency()
    ...
    RPC.execute('FIXDEV-voice:atc:unsubscribe')
...
function LoadATCModule()
    ...
    exports["FIXDEV-keybinds"]:registerKeyMapping("", "ATC", "Push-To-Talk", "+transmitToATCRadio", "-transmitToATCRadio")
    ...
    exports["FIXDEV-keybinds"]:registerKeyMapping("", "ATC", "On / Off", "+toggleATCRadioState", "-toggleATCRadioState")
    ...
    exports["FIXDEV-keybinds"]:registerKeyMapping("", "ATC", "Volume Up", "+increaseATCRadioVolume", "-increaseATCRadioVolume")
    ...
    exports["FIXDEV-keybinds"]:registerKeyMapping("", "ATC", "Volume Down", "+decreaseATCRadioVolume", "-decreaseATCRadioVolume")
    ...
    RegisterNetEvent('FIXDEV-voice:atc:connect', ConnectToATCFrequency)

    RegisterNetEvent('FIXDEV-voice:atc:disconnect', DisconnectFromATCFrequency)

    RegisterNetEvent('FIXDEV-voice:atc:setPowerState', SetATCRadioPowerState)

    RegisterNetEvent('FIXDEV-voice:atc:addSubscriber', AddATCSubscriber)

    RegisterNetEvent('FIXDEV-voice:atc:removeSubscriber', RemoveATCSubscriber)
