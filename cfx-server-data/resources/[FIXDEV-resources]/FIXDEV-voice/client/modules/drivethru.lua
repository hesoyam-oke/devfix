...
function ConnectToDTFrequency(pIsHeadset)
    local subscribers = RPC.execute('FIXDEV-voice:drivethru:subscribe')
...
function DisconnectFromDTFrequency()
    ...
    RPC.execute('FIXDEV-voice:drivethru:unsubscribe')
    DTIsHeadset = false
...
function LoadDTModule()
    ...
    exports["FIXDEV-keybinds"]:registerKeyMapping("", "DriveThru Headset", "Push-To-Talk", "+transmitToDriveThru", "-transmitToDriveThru")
    ...
    exports["FIXDEV-keybinds"]:registerKeyMapping("", "DriveThru Headset", "On / Off", "+toggleDTRadioState", "-toggleDTRadioState")
    ...
    exports["FIXDEV-keybinds"]:registerKeyMapping("", "DriveThru Headset", "Volume Up", "+increaseDTVolume", "-increaseDTVolume")
    RegisterCommand('+increaseDTVolume', IncreaseDTRadioVolume, false)
    RegisterCommand('-increaseDTVolume', function() end, false)

    exports["FIXDEV-keybinds"]:registerKeyMapping("", "DriveThru Headset", "Volume Down", "+decreaseDTRadioVolume", "-decreaseDTRadioVolume")
    ...
    RegisterNetEvent('FIXDEV-voice:drivethru:connect', ConnectToDTFrequency)

    RegisterNetEvent('FIXDEV-voice:drivethru:disconnect', DisconnectFromDTFrequency)

    RegisterNetEvent('FIXDEV-voice:drivethru:setPowerState', SetDTRadioPowerState)

    RegisterNetEvent('FIXDEV-voice:drivethru:addSubscriber', AddDTSubscriber)

    RegisterNetEvent('FIXDEV-voice:drivethru:removeSubscriber', RemoveDTSubscriber)

    -- scuffed way of overriding vanilla keybind
    AddEventHandler('FIXDEV:voice:transmissionStarted', function()
