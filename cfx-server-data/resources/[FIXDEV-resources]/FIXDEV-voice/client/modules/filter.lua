...
RegisterNetEvent("FIXDEV:voice:connection:state")
AddEventHandler("FIXDEV:voice:connection:state", function (serverID, isConnected)
...
AddEventHandler('FIXDEV:voice:state', function (isActive)
