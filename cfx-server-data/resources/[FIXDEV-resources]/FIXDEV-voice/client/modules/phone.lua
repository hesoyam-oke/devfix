...
function LoadPhoneModule()
    ...
    RegisterNetEvent("FIXDEV:voice:phone:call:start")
    AddEventHandler("FIXDEV:voice:phone:call:start", StartPhoneCall)

    RegisterNetEvent("FIXDEV:voice:phone:call:end")
    AddEventHandler("FIXDEV:voice:phone:call:end", StopPhoneCall)
    ...
    TriggerEvent("FIXDEV:voice:phone:ready")

    Debug("[Phone] Module Loaded")
end

RegisterNetEvent('FIXDEV-voice:setTransmissionDisabled', function ()
    WasEventCanceled()
