...
RegisterNetEvent("cocaine-search", function()
    ...
    local finished = exports["FIXDEV-taskbar"]:taskBar(3000,"Searching Vehicle")
...
RegisterNetEvent("FIXDEV-heists:cocaine:failure")
AddEventHandler("FIXDEV-heists:cocaine:failure", function ()
...
RegisterNetEvent("FIXDEV-heists:cocaine:begin_start")
AddEventHandler("FIXDEV-heists:cocaine:begin_start", function ()
...
RegisterNetEvent("FIXDEV-heists:cocaine:success:2")
AddEventHandler("FIXDEV-heists:cocaine:success:2", function ()
    if not enabled or not eventStarted then
        return
    end
    blackoutStatus = false
...
RegisterNetEvent("FIXDEV-heists:cocaine:success:3")
AddEventHandler("FIXDEV-heists:cocaine:success:3", function ()
    if not enabled or not eventStarted then
        return
    end
    blackoutStatus = false
...
RegisterNetEvent("FIXDEV-heists:cocaine:success:4")
AddEventHandler("FIXDEV-heists:cocaine:success:4", function ()
...
Citizen.CreateThread(function()
    ...
    -- exports["FIXDEV-polytarget"]:AddBoxZone("heist_cocaine_phonecall", vector3(129.2166,244.865,107.45), 3.5, 3.5, {
    --     heading= 0
    -- })
    ...
    exports['FIXDEV-interact']:AddPeekEntryByPolyTarget('heist_cocaine_phonecall', {{
        event = "FIXDEV-heists:cocaine:failure",
    ...
    -- exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall', {{
    --     event = "FIXDEV-heists:cocaine:begin_start",
    ...
    -- exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_second', {{
    --     event = "FIXDEV-heists:cocaine:failure",
    ...
    -- exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_second', {{
    --     event = "FIXDEV-heists:cocaine:success:2",
    ...
    -- exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_third', {{
    --     event = "FIXDEV-heists:cocaine:failure",
    ...
    -- exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_third', {{
    --     event = "FIXDEV-heists:cocaine:success:3",
    ...
    -- exports["FIXDEV-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_four', {{
    --     event = "FIXDEV-heists:cocaine:success:4",
...
RegisterNetEvent("FIXDEV-heists:doVehicle", function(pVehicle, x,y,z)
...
RegisterCommand('cocaine', function()
    ...
    Wait(5500)
    TriggerEvent('FIXDEV-heists:cocaine:success:4')
end)