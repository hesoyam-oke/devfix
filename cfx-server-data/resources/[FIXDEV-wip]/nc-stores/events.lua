...
RegisterNetEvent("FIXDEV-stores:PedLoop", function(ped, spawn, store)
...
RegisterNetEvent('FIXDEV-inventory:general', function()
    TriggerEvent('OpenInventory', 'store', "general")
end)

RegisterNetEvent('FIXDEV-inventory:vendingMachine', function(pParams, pEntity, pContext)
    TriggerEvent("OpenInventory", 'store', "vending")
end)

RegisterNetEvent('FIXDEV-inventory:weap', function()
    if exports["FIXDEV-license"]:HasLicense("weapons") then
        if exports["FIXDEV-license"]:GetLicensePoints("weapons") < 30 then
...
RegisterNetEvent('FIXDEV-inventory:hunting', function()
    TriggerEvent('OpenInventory', 'store', "hunting")
end)

RegisterNetEvent('FIXDEV-inventory:mall', function()
    TriggerEvent("OpenInventory", 'store', "mall")
end)

RegisterNetEvent('FIXDEV-inventory:youtool', function()
    TriggerEvent("OpenInventory", 'store', "youtool")
end)

RegisterNetEvent('FIXDEV-inventory:pdlocker', function()
    TriggerEvent("OpenInventory", 'store', "cop")
end)

RegisterNetEvent('FIXDEV-inventory:doclocker', function()
    TriggerEvent("OpenInventory", 'store', "doc")
end)

RegisterNetEvent('FIXDEV-inventory:emslocker', function()
    TriggerEvent("OpenInventory", 'store', "ems")
end)

RegisterNetEvent('FIXDEV-inventory:bar', function()
