...
-- -105.12893676758, 6471.46484375, 31.626705169678 Heading: 40.885322570801
            if exports["FIXDEV-inventory"]:hasEnoughOfItem("thermite",1,false) then
                FreezeEntityPosition(PlayerPedId(),true)
                local FirstDoorBigBank = exports["FIXDEV-taskbar"]:taskBar(9000,"Preparing For Hack")
                if FirstDoorBigBank == 100 then
                    ...
                    function() -- Success
                        ...
                        TriggerEvent('FIXDEV-vaultDoor3', -1, method)
                        --TriggerEvent('FIXDEV-ffs2:startheist')
                    ...
                    --     function() -- success
                    --         StopAnimTask(PlayerPedId(), hackAnimDict, "hack_loop", 1.0)
                    --         TriggerEvent('FIXDEV-vaultDoor2', -1, method)
                    --         TriggerEvent('FIXDEV-ffs2:startheist')
    ...
    if distance < 1.5 then
        if exports["FIXDEV-inventory"]:hasEnoughOfItem("thermite",1,false) then
            ...
            if FirstDoorBigBank == 100 then
                ...
                exports["memorygame"]:thermiteminigame(1, 3, 4, 10,
                function() -- Success
                    TriggerEvent("FIXDEV-BayCityTriggerSecondDoor")
                    TriggerEvent("inventory:removeItem","thermite",1)
                    TriggerEvent('DoLongHudText', 'Well done dumbass please cry more!', 2)
                end,
                function() -- failure
...
RegisterNetEvent('FIXDEV-BayCityTriggerSecondDoor')
AddEventHandler('FIXDEV-BayCityTriggerSecondDoor', function()
	anim66()
	Citizen.Wait(3500)
end)

RegisterNetEvent('FIXDEV-Seconddoorsbaycity') 
AddEventHandler('FIXDEV-Seconddoorsbaycity', function()
    TriggerServerEvent("FIXDEV-doors:change-lock-state", 524, false)
end)
    ...
    if distance < 1.5 then
        if exports["FIXDEV-inventory"]:hasEnoughOfItem("thermite",1,false) then
            ...
            if FirstDoorBigBank == 100 then
                ...
                exports["memorygame"]:thermiteminigame(1, 3, 4, 10,
                function() -- Success
                    TriggerEvent("FIXDEV-BayCityTriggerFirstDoor")
                    TriggerEvent("inventory:removeItem","thermite",1)
                    TriggerEvent('DoLongHudText', 'Well done dumbass please cry more!', 2)
...
RegisterNetEvent('FIXDEV-BayCityTriggerFirstDoor')
AddEventHandler('FIXDEV-BayCityTriggerFirstDoor', function()
	anim69()
	Citizen.Wait(3500)
end)

RegisterNetEvent('FIXDEV-firstdoorsbaycity') 
AddEventHandler('FIXDEV-firstdoorsbaycity', function()
    TriggerServerEvent("FIXDEV-doors:change-lock-state", 525, false)
end)
...
RegisterNetEvent('FIXDEV-vaultDoor3')
AddEventHandler('FIXDEV-vaultDoor3', function(method)
...
RegisterNetEvent("FIXDEV-baycity:getDoorCheckCL")
AddEventHandler("FIXDEV-baycity:getDoorCheckCL", function(result)
...
Citizen.CreateThread(function()
    ...
    while true do 
        ...
        if isNear then
            TriggerServerEvent('FIXDEV-baycity:getGetDoorStateSV')
...
RegisterNetEvent("FIXDEV-ptfxparticlebaycity")
AddEventHandler("FIXDEV-ptfxparticlebaycity", function(method)
    local ptfx
...
-- 252.99769592285, 220.96379089355, 101.68360137939 Heading: 166.93214416504
    ...
    TriggerServerEvent("FIXDEV-particleserverbaycity", method)
    SetPtfxAssetNextCall("scr_ornate_heist")
    local effect = StartParticleFxLoopedAtCoord("scr_heist_ornate_thermal_burn", ptfx, 0.0, 0.0, 0.0, 1.0, false, false, false, false)
    ...
    DeleteObject(bomba)
    StopParticleFxLooped(effect, 0)
	TriggerEvent("FIXDEV-Seconddoorsbaycity")
end

RegisterNetEvent("FIXDEV-ptfxparticlebaycity1")
AddEventHandler("FIXDEV-ptfxparticlebaycity1", function(method)
    local ptfx
...
-- 252.99769592285, 220.96379089355, 101.68360137939 Heading: 166.93214416504
    ...
    DetachEntity(bomba, 1, 1)
    FreezeEntityPosition(bomba, true)
    TriggerServerEvent("FIXDEV-particleserverbaycity1", method)
    SetPtfxAssetNextCall("scr_ornate_heist")
    local effect = StartParticleFxLoopedAtCoord("scr_heist_ornate_thermal_burn", ptfx, 0.0, 0.0, 0.0, 1.0, false, false, false, false)
    ...
    DeleteObject(bomba)
    StopParticleFxLooped(effect, 0)
	TriggerEvent("FIXDEV-firstdoorsbaycity")
end